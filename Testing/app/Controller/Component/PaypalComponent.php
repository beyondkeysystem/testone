...
class PaypalComponent extends Component {
    ...
    //------------------------------------
    //public $API_UserName = 'prime2_1359382701_biz_api1.cisinlabs.com';
    //public $API_Password = '1359382722';
    //public $API_Signature = 'AxVHV5sG-WxUA.zltwMpL--8SZ7IA51Q8L2WnQ7PROFHNtVkLHB9wI1Y'; //$API_Signature = "AiPC9BjkCyDFQXbSkoZcgqH3hpacASX-h0YZg5AssCcmz230GPasZu63";
    ...
    public $API_AppID =APP_ID;
    public $API_Endpoint = "";

    function __construct(ComponentCollection $collection) {
    ...
    function CallPaymentDetails($payKey, $transactionId = null, $trackingId = null) {//echo "pay key======".$payKey."==transactionId======".$transactionId."==trackingId=======".$trackingId;die;
