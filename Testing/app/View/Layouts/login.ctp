...
<head>
	...
	<?php
		...
		echo $this->Html->css('login/css/bootstrap.min.css'); 
		echo $this->Html->css('login/css/font-awesome.css');
	?>
		<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>
	<?php
		echo $this->Html->css('login/css/animated');
		echo $this->Html->css('login/css/style'); 
		echo $this->Html->css('login/css/responsive'); 
