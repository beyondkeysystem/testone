 <div id="content">
    ...
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <!-- <button data-original-title="Copy" type="submit" form="form-product" formaction="products/copy" data-toggle="tooltip" title="" class="btn btn-default"><i class="fa fa-copy"></i></button>
         -->
        <button data-original-title="Delete" type="submit" form="form-product" formaction="tickets/delete" data-toggle="tooltip" title="" class="btn btn-danger" onclick="confirm('Delete/Uninstall cannot be undone! Are you sure you want to do this?') ? $('#form-product').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
      <h1>Tickets</h1>
  ...
  <div class="container-fluid">
      ...
      ?>
       <?php echo $this->Form->create('Ticket',array('action' => 'admin_index'),array('class'=>'form-horizontal','name' => 'form-product-search','type'=>'get'));?> 
        <div class="well">
          <div class="row">
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <div class="form-group">
                  <label class="control-label" for="input-name">Customer Name</label>
                  <?php echo $this->Form->input('TicketStatus.status',array(
              ...
              if(!empty($tickets)){
                ...
                ?>
                  <tr>
                    ...
                    <td class="text-left"><?=$ticket['Customer']['firstname'].' '.$ticket['Customer']['lastname']?></td>
