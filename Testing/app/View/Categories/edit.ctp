...
<!-- Data Tab Starts Here -->
            <div class="tab-pane fade" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <!-- <a id="thumb-image" class="img-thumbnail" data-toggle="image" href=""> -->
                    <img data-placeholder="<?=$this->webroot."uploads/thumbs/".$image_name; ?>" title="" alt="" src="<?php echo $this->webroot."uploads/thumbs/".$image_name; ?>">
                    <!-- <img data-placeholder="<?=WWW_ROOT?>uploads/thumbs/" title="" alt="" src="<?=WWW_ROOT?>uploads/thumbs/"> -->
                  <!-- </a> -->
                  <?php 
