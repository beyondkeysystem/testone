        ...
        <div class="my-order clearfix">
            <div class="row clearfix">
                ...
                <div class="col-md-9">
                        ...
                        <div class="reminder-table">
                            <table width="100%" border="0" class="table-main">
                                <tr class="table-heading">
                                    <td colspan="5"><?php echo __('Order number');?>： <?php echo $orderdetail['OrderDetail']['order_no'];?> <span><?php echo __('Order placed on');?>：<?php echo $orderdetail['OrderDetail']['created']?></span></td>
                                </tr>
                                <tr>
                                    <td width="310">
                                        <?php 
                    ...
                    <div>please call (03) 92263000 for bank in information.</div>
                </div>
            </div>
        </div>
    </div>
