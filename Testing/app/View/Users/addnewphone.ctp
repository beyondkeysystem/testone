<?php echo $this->Form->create('Emailmodel', array('url'=>'/users/change_phone','id' => 'phoneform')); ?>
...
<div class="field-area clearfix">
    <div class="main-row clearfix">
        <?php echo $this->Form->text('Emailmodel.phone_val', array('class' => "field-area-left", 'placeholder' => "Phone", 'required' => false)) ?>
    </div>
    ...
    <div class="submit-row">
        <input type="button" onclick="return fnchange_phone();" value="Submit" name="phone" class="subnit-btn">
