...
<!--                    <div class="select-drop clearfix">
                    ...
                    <ul class="form-field clearfix">
                        <li>
                            <div class="form-field-label"><?php echo __('Enter Email address');?> </div>
                            <div class="form-field-input">
                                <?php echo $this->Form->text('User.username',array('class'=>"input-field validate-txt",'placeholder'=>'Email address','required'=>false));?>
                            </div>
                            <?php 
                                $error = $this->Form->error('User.username');
                            if(isset($error)){?>
                            <div class="error-message">   
                                <!--<i class="fa fa-info-circle"></i>--> <?php echo $this->Form->error('User.username');?> 
                            </div>
                            <?php }?>
                        </li>
                        ...
                        <li>
                            <div class="by-clicking"> 
                                ...
                                <?php echo __('By clicking');?> "<a href="javascript:void(0)"><?php echo __('Create an account'); ?>"</a>, <?php echo __('you agree to HaRiMau Globaltech Sdn Bhd'); ?> 
                        ...
                        <li>
                            ...
                            <input type="button" onclick="window.location.href='/users/signup'" class="login-btn full Fright" value="Register using phone">
                        </li>
                    </ul>
                </div>
                <?php echo $this->Form->end();?>
