      ...
      <div class="container-fluid">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <?php echo $this->Form->create('Orderprices',array('class'=>"form-horizontal", 'id'=>"form-customer"));?>
                            ...
                            <div class="tab-content">
                                    <div id="tab-customer" class="tab-pane active">
                                        <div class="form-group">
                                            <label for="input-fax" class="col-sm-2 control-label">Order Price</label>
                                            <div class="col-sm-10">
                                                <?php echo $this->Form->number('price',array('class'=>"form-control",'placeholder'=>"Order Price",'required'=>false ));?>
