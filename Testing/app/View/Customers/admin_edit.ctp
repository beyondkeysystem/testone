          ...
          <div class="panel-body">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab-address<?=$j?>">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-postcode1">State</label>
                        <div class="col-sm-10">
                          <input name="Address[<?=$i?>][state]" value="<?=$customer['Address'][$i]['state']?>" placeholder="State" id="input-State<?=$j?>" class="form-control" type="text">
                        </div>
                      </div>
                      ...
                      if($customer['Address'][$i]['is_default'] != 0){
                        $selected="checked=''";
                      }
                      else{
                        $selected="";
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <label class="radio">
                            <input name="Address[<?=$i?>][default]" value="1" <?=$selected?> type="radio">
                          </label>
                        </div>
                      </div>
                    </div>
