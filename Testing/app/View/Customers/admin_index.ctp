          ...
          <div class="row">
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="input-name" placeholder="Customer Name" name="data[Customer][fullname]" autocomplete="off"><ul class="dropdown-menu">
            ...
            <div class="col-sm-3">
              ...
              <div class="form-group">
                <label for="input-ip" class="control-label">Phone</label>
                <input type="text" class="form-control" id="input-phone" placeholder="Phone" name="filter_phone">
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
              ...
              <thead>
                <tr>
                 ...
                 <?php echo $this->Paginator->sort('status',__('Status')); ?>
                  ...
                  <td class="text-left">
                 <?php echo $this->Paginator->sort('telephone',__('Phone')); ?>
                    </td>
                  <td class="text-left">
              ...
              <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="text-left"><?php if($customer['Customer']['fullname'] != ''){ echo $customer['Customer']['fullname'];}else{ ?><?=$customer['Customer']['firstname']?> <?=$customer['Customer']['lastname']?><?php }?></td>
                      ...
                      <td class="text-left"><?=$customer['Customer']['telephone']?></td>
