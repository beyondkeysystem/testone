...
return [
	...
	*/
	...
	"digits"           => ":attribute musí být :digits číslic dlouhé.",
	"digits_between"   => ":attribute musí být dlouhé nejméně :min a nejvíce :max čísel.",
	"email"            => ":attribute není platný formát.",
	"exists"           => "Zvolená hodnota pro :attribute není platná.",
	"image"            => ":attribute musí být obrázek.",
	"in"               => "Zvolená hodnota pro :attribute není platná.",
	"integer"          => ":attribute musí obsahovat pouze čísla.",
	...
	*/
	...
	'custom' => [
		'email' => [
			'email' => 'Nezadali jste platnou emailovou adresu.',
			'required' => 'Emailová adresa musí být vyplněna',
			'unique' => 'V našem systému již existuje registrovaný účet pod touto emailovou adresou.',
		],
		'username' => [
			'unique' => 'Vámi zvolené uživatelské jméno je již bohužel obsazeno.'
		]
	],
