<?php
//if(isset($_REQUEST['show']) && $_REQUEST['show']=='contact'){
...
<div class="contact-form clearfix">
				...
				<div class="main-form clearfix">
					<span style="color:red">*</span>First Name:<input type="text" name="Name" class="former"/>
					<span style="color:red">*</span>Phone:<input type="text" value=""  class="former" placeholder="Country Code + (555)555-5555"/>
					<span style="color:red">*</span>Email:<input type="text" value="" class="former" name="Email"/>
