	...
	*/
	...
	if($_REQUEST['AID']==''){   //die('test');
		...
		while($row = mysql_fetch_array($sql_result)){ //echo $row['Name']."=>".$row['id'];
			...
			if($MilesR <= 3000){
				...
				print "
				<div class='cewleft'>
				<div class='cewleft-inner'><img src='images/dpic.jpg' width='120' height='140'>
				</div>
				</div>
				<div class='cewright'>
				<span class='bluespan'>
				...
				$Broker_Name
				<span class='red'><b>$Miles miles away</b></span> <p>Contact me today for all your real estate needs!</p>";
			       if($Check_ID == $ID){
					...
					<div class='cewbtn'><img src='aho/32-iphone-icon.png' style='vertical-align:middle;'> <span style='font-weight:bolder;color:#1982d1;font-size:15px;'>{$phone_no}</span></a>
					<a href='aho.ph' class='AHO_Email' id='$ID'><img src='aho/18-envelope-icon.png' style='vertical-align:middle;'> <span style=''>Email</span></a>   </div>
					";
			
					}else{
					print "
					</div>
					<div class='cewbtn'><a href='aho.php' class='AHO_Call'  id='$ID'><img src='aho/32-iphone-icon.png' style='vertical-align:middle;'> Call</a><a href='aho.php' class='AHO_Email' id='$ID'><img src='aho/18-envelope-icon.png' style='vertical-align:middle;'> <span style=''>Email</span></a> </div>
	...
	if(isset($_REQUEST['AID']) && $_REQUEST['AID']!='' and $_REQUEST['Form_Send']!='1'){ 
		...
		print "
			<div class='agentbox1'>
			<div class='cewleft'>
			<div class='cewleft-inner'><img src='images/dpic.jpg' width='120' height='140'></div>
			</div>
			<div class='cewright'>
			...
			<span class='red'><b>$Miles miles away</b></span>
		...
		print "
			...
			Comments or Suggestions? <textarea style='width:95%;height:60px;' id='Comment' name='Comment'>";
	...
	if(isset($_REQUEST['Form_Send']) && $_REQUEST['Form_Send']=='1'){ 
		...
		$header = "From:support@americanhomesonline.com\r\n"; 
		$header.= "MIME-Version: 1.0\r\n"; 
		$header.= "Content-Type: text/html; charset=utf-8\r\n"; 
		$header.= "X-Priority: 1\r\n"; 
		$send=mail($AEmail,"AHO Contact Form to ".$_REQUEST['Email'],$body,$header);
		...
		$body="<b>Your agent's info</b><br>
			...
			Click <a href='http://americanhomesonline.com/closest_agent.php'>here</a> to see Agents Profile.
			";
		$header = "From:support@americanhomesonline.com\r\n"; 
		$header.= "MIME-Version: 1.0\r\n"; 
		$header.= "Content-Type: text/html; charset=utf-8\r\n"; 
		$header.= "X-Priority: 1\r\n"; 	
		$send = mail($email,"AHO Contact Form to ".$_REQUEST['Email'],$body,$header);
		...
		*/
		...
		if($num_rows > 0){
			...
			while($row = mysql_fetch_array($sql_result)){
				...
				<a href='aho.php' class='AHO_Email' id='$ID'><img src='aho/18-envelope-icon.png' style='vertical-align:middle;'> <span style=' '>Email</span></a>   &nbsp;&nbsp;&nbsp;<a href='$Web' target='_blank' id='$ID'> <img src='aho/iconmonstr-home-icon-16.png' style='vertical-align:middle;'> <span style='f'>$Website_Name</span></a>
				...
				<a href='aho.ph' class='AHO_Email' id='$ID'><img src='aho/18-envelope-icon.png' style='vertical-align:middle;'> Email</a>  &nbsp;&nbsp;&nbsp; <a href='aho.ph' class='AHO_Email' id='$ID'><img src='aho/iconmonstr-home-icon-16.png' style='vertical-align:middle;'>  $Website_Name</a>
				";
