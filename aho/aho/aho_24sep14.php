	...
	*/
			...
			if($MilesR <= 3000){
				...
				<span class='red'><b>$Miles miles away</b></span> <p>Contact me today for all your real estate needs!</p>";
			       if($Check_ID == $ID){ 
					...
					<div class='cewbtn'><img src='aho/32-iphone-icon.png' style='vertical-align:middle;'> <span style='font-weight:bolder;color:#1982d1;font-size:15px;'>{$row['Phone_1']}</span></a>
	...
	if(isset($_REQUEST['AID']) && $_REQUEST['AID']!='' and $_REQUEST['Form_Send']!='1'){ 
		...
		print "
			...
			<span class='red'>
			<p>Please fill in the form and receive agent's info.</p>
			</span>
			...
			<div>
				...
				<span style='color:red'>*</span>Last Name:<input type='text' value='" . $_SESSION['form_name'] . "' style='width: 95%;' id='Last_Name' class='former' name='Last_Name'>
			...
			Suggestions: <textarea style='width:95%;height:60px;' id='Comment' name='Comment'>";
