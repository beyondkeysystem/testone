...
if(isset($_POST['send_request']) && $_POST['send_request']=='Submit'){
    ...
    if($query){
        ...
        $headers .= 'From: American Homes Online<sameer@mailinator.com>' . "\r\n";
        // $headers .= 'Cc: birthdayarchive@example.com' . "\r\n";
        // $headers .= 'Bcc: birthdaycheck@example.com' . "\r\n";
        // Mail it
        $flag= mail($to, $subject, $message, $headers);
        if($flag){
            header("location:http://www.americanhomesonline.com/personal_details.php?RquestMessage=1");
        }
        else{
            header("location:http://www.americanhomesonline.com/personal_details.php?RquestMessage=0");
        }
        ...
        if($query && mysql_num_rows($query)>0){
         ...
         // code to find latitude and longitude of property start
            ...
            $sql = "SELECT *,
				...
				FROM AHO_User WHERE credits>=3 AND Type=3 
