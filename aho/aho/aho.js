...
jQuery( document ).ready(function( $ ) {
	...
	jQuery('#AHO-Remote-Load').html('<img id="loader" src="http://americanhomesonline.com/images/ajax_loader_blue_128.gif" />');	
	...
	jQuery( "#AHO-Remote-Load" ).load( url+"?APPid="+APPid[1]+'&AHO_AS='+loc, function(){
		jQuery('#loader').remove();
	});
