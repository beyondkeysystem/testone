...
$sql_result = mysql_query($sql);
   ...
   print  "<table class = 'sTable'>";
      ...
      echo "<th style='font-weight: bolder; font-size: 22px; color: black;'>Amount (in Dollars)</th>";
       ...
       echo "<th style='font-weight: bolder; font-size: 22px; color: black;'>No of Credits</th>";
...
while ($row = mysql_fetch_array($sql_result)) { 
    ...
    if($row['type']=='credit'){ if($row['amount_status']){$amount_status='Free';}else{$amount_status='Paid';}
