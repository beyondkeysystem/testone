	    ...
	    if($q1){
			...
			$message = '
			   ...
			   <body>
			     ...
			     <p>You have accepted a Lead for "Property Search for Buy" on <a href="http://www.americanhomesonline.com">American Homes Online</a> on '.date('d-M-Y h:i:s').'. </p>
			...
			$message = '
			   ...
			   <body>
			     <p>Hello '.$Full_Name.'</p>
			     <p>Your Lead for "Property Search for Buy" has been accepted on <a href="http://www.americanhomesonline.com">American Homes Online</a> on '.date('d-M-Y h:i:s').' by Agent '.$Agent_Name.'</p>
				...
				<tr>
				 <th>Agent Name</th><td>'.$Agent_Name.'</td>
			       ...
			       <tr>
				 <th>Email ID</th><td>'.$Agent_Email.'</td>
			       </tr>
			       <tr>
				 <th>Cell No</th><td>'.$Agent_Phone.'</td>
			       </tr>
			       <tr>
