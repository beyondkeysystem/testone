...
if(!empty($ID) && isset($_REQUEST['send'])&& $_REQUEST['send']==1)
{
	...
	?>
	<script type="text/javascript">
		window.location="index.php?Page=Accounts&ID=<?php echo $ID?>&Step=3";
	</script>
	<?php
...
else
{
	...
	?>
		...
		?>
			<h3 class="steps"><a href="index.php?Page=Accounts&ID=<?php echo $ID?>&Step=1">Step 1 <span class="stepsdescription"> > Account Info</span></a></h3><h3 class="steps currentstep">Step 2 <span class="stepsdescription"> > Send Mail</span></h3><h3 class="steps"><a href="index.php?Page=credits&ID=<?php echo $ID?>">Step 3 <span class="stepsdescription"> > Buy Credits</span></a></h3>
			<br><br>
