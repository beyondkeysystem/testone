...
while ($row = mysql_fetch_array($sql_result)) {
	...
	?>
	<a href='http://www.americanhomesonline.com/admin/index.php?Page=AllAgents&remove_agent=<?php echo $row['id'];?>' class='various fancybox.iframe button bactive bsmall' style='font-size:12px;' onclick=" return confirm('Do you really want to delete this agent?')">Remove</a></li></ul>   
...
<div id="step1">
	<form action="index.php?Page=AllAgents" method="post" data-ajax="false" data-mini="true" enctype="multipart/form-data" class="adminforms">
		...
		<div data-role="fieldcontain" class="ui-hide-label">
			<label for="aUsername">Phone: </label>
			<?php
			$find = array("(",")","+","-");
			$replace = '';
