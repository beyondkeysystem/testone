...
<br>
	...
	<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
		<b>Purchase Additional Credits</b>  
			...
			<input type="hidden" name="notify_url" value="http://americanhomesonline.com/demo/admin/index.php?Account=10" />
            <input type="hidden" name="return" value="http://americanhomesonline.com/demo/admin/index.php?Account=10" />
            <input type="hidden" name="cancel_return" value="http://americanhomesonline.com/demo/admin/index.php?Page=cancel" />
            <input type="hidden" name="email" value="<?php echo $Email_1; ?>" />
            <input type="hidden" name="bid" value="<?php echo $B_ID; ?>" />
&nbsp;<input name="submit" type="submit" class='button binactive bsmall'  id="submit" value="BUY" style=" cursor:pointer;" />
          </form>
	<?php }else{ ?>
	
  <form action="http://americanhomesonline.com/demo/admin/index.php?Page=Accounts&credit=true" method="post">
