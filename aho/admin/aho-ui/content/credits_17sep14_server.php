...
<span style='font-size:32px; font-weight:bold; color:<?php echo ($total < 15) ? '#f00' : '#036'; ?>'>Credits Remaining: <?php echo $total; ?></span><br>
	...
	<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
		...
		<input type="hidden" name="return" value="http://alpha.cisinlabs.com:81/americanhomesonline/ahoCore/admin/index.php?Page=credits&ID=<?php echo $AID;?>" />
		<input type="hidden" name="cancel_return" value="http://alpha.cisinlabs.com:81/americanhomesonline/ahoCore/admin/index.php?Page=cancel" />
