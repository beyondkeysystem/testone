...
if($Branch > 1){
	...
	<a href='aho-ui/content/pops/remove.php?ID={$row['id']}' class='various  button bactive bsmall' onclick='return confirm(\"Do you really want to delete this agent? \");' style='font-size:12px;'>Remove</a></li></ul>
	</div>";
