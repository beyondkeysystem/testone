  ...
  <div class="inner-wrap">
    ...
    <table>
     ...
     <!-- <h1>Buy your dream home</h1>
      <span> </span>-->
      <div class="title-txt"> 
      Fill out the form and receive 100% accurate, available properties from your closest
	  <p> <b>"Personal Intelligent Agent"</b></p>
  <!--    <p>The closest <strong>"Personal Intelligent Agents"</strong> do the work <a href="#">for you</a> and are available at a moment's notice.</p>
       Our Goal is to Provide, <span>"Customer Support & Professional Real Estate Guidance"</span>.-->
      </div>
    </div>
    <!---->
    <!--<form method="post" name="buy_form" id="buy_form">-->
    <div class="buy-form"><form method="post" name="rental_form" id="rental_form" action="personal_details.php">
     ...
     <div class="sec">
      ...
      <div class="form-row half">
          ...
          <div class="sec">
            <label><span>*</span>Pets</label>
            <select class="custom-select" id="pets" name="pets">
          ...
          <div class="sec">
            ...
            <select class="custom-select" id="time_frame" name="time_frame">
      ...
      <div class="form-row">
	   ...
	   <input type="hidden" value="2" name="request_type" id="request_type"/> <!-- type 2 for rental -->	
