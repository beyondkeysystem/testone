...
class Property_type_model extends CI_Model {
    ...
    * @return array
    */
    public function get_property_type($search_string=null, $order=null, $order_type='Asc', $limit_start=null, $limit_end=null)
    {
		...
		if($order){
		    ...
		    $this->db->order_by('type', $order_type);
		}
    ...
    * @return int
    */
    function count_property_type($search_string=null, $order=null)
    {
		$this->db->select('*');
		$this->db->from('property_type');
		if($search_string){
    ...
    * @return boolean 
    */
    function store_property_type($data)
    {
		$insert = $this->db->insert('property_type', $data);
	    return $insert;
	}
