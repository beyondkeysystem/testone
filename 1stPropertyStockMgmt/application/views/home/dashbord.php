 ...
 <tr>
  ...
  <tr>
        ...
        <table class="pltable">
            <tbody>
                <tr>
                    ...
                    ?>
                        <?php echo $property_information['sell_property_share']; ?>
                    <?php
                        }else{
                            echo (100 - $property_information['property_share_in_per']);
                        }
                    ?>
    ...
    <td>
        ...
        <!-- <img src="<?php echo base_url(); ?>assets/front/images/adg.png" alt=""> -->
    </td>
  </tr>
