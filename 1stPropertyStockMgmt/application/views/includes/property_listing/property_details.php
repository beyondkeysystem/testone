  ...
  <div id="container">
   <div id="tabs">
      <ul>
        ...
        <!-- <li><a href="#tab-3">Property Details</a></li> --> <!--Mayank Pawar -->
      </ul>
...
<?php
	  ...
	  <div class="" id="credit_div" style="display: none;">
		<div class="row-col1">
		  <label>Token Needed: <span id="creditsneeded"></span> <br/>Now you have remains <span id="creditsavailable"><?=$user_credit[0]['credit']?></span> token and your remaining share <span id="shareremaining"></span> if you agreed to buy</label>
		</div>
	  </div>
	 ...
	 <div class="search_btn"><input type="submit" id="agree" value="Agree" /></div>
	  <!--div class="signup">Not A Member ?   <a href="http://myviko.pd.cisinlive.com/register"> Sign up Now!</a></div-->
	</form>
  </div>
<!--/.Popup-->
	...
	if (share <= shareavail) {
	  ...
	  if (share_price != 0) {
		...
		if(parseFloat(totalprice) <= parseFloat(totalcreditamt)){
		  ...
		  $("#user_credit_agree").val(remainingcredit);
