...
/*			[id] => 1
            ...
            [credit] => 0 */
?>
	<h3>Current Funds: <span class="col-b" id="bal">MYR 50,000.00</span></h3>
		...
		<div class="resp-tabs-container">
			...
			<div>
			 <table cellpadding="0" cellspacing="0" border="0" width="100%" >
					...
					$debit_token= number_format($val['debit']/$credit_price[0]['price']);
					$credit_token= number_format($val['credit']/$credit_price[0]['price']); ?>
					  <tr>
						<td><?php echo date ("d/m/Y", strtotime($val['date'])); ?></td>
						<td><?php echo $val['detail']; ?></td>
