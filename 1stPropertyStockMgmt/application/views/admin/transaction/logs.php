      ...
      <div class="row">
            <div class="span12 columns">
                <div class="well">
                    ...
                    <form id="myform" class="form-inline reset-margin" accept-charset="utf-8" method="post" action="<?php echo base_url()?>transaction/fundlog">              
                        <div class="row-fluid">
                            <div class="span3">
                            ...
                            <div class="span3">
                                ...
                                <input type="text" placeholder="Search by Email" value="<?php echo $this->session->userdata('search_email') //if(isset($email) and $email !='') echo $email?>" name="email">                
                            </div>
                            <div class="span3">
                                <label for="location">
                                    <b>Fund type</b>
                                </label><br>
                                <input type="text" placeholder="Search by Fund type" value="<?php echo $this->session->userdata('search_fund_type')//if(isset($fund_type) and $fund_type !='') echo $fund_type?>" name="fund_type">                
                            </div>
                        </div>
