...
<!--             </div>
 ...
 -->          
         ...
         <div class="control-group">
            ...
            <div class="controls">
              <input type="number"  step="any" min="0.1"  class="built_up"  name="built_up" value="<?php echo set_value('built_up'); ?>"> sq. ft
              <!--<span class="help-inline">OOps</span>-->
            </div>
          </div>
          <div class="control-group">
            ...
            <div class="controls">
              <?php echo form_dropdown('tenure', $options_tenure, set_value('tenure'), 'class="span2"');
              ?>
              <!--<span class="help-inline">OOps</span>-->
            </div>
          </div>
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text"  class="land_area"  name="land_area" value="<?php echo set_value('land_area'); ?>">
              <!--<span class="help-inline">OOps</span>-->
            </div>
          </div>
          <div class="control-group">
