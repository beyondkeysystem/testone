              ...
              if(!empty($pending_property)){
                ...
                $page_number = $arr[0];
                    if($page_number > 1){
                      ...
                      foreach($property as $row)
                      {
                        ...
                        }else if($row['property_enable_disable'] == 0 ){
                        ...
                        // echo (($current - $created)/(60*60*24))."diff<br/>";
                        // echo $row['property_status'];

                        if($row['property_status'] == "selling" && (($current - $created)/(60*60*24)) > 30 && $row['property_enable_disable'] != 3){
                          $enable_disable =  "<span style='color:red' title='Exceeds 30 days from date of property created'>Exceeds 30 days</span>";
                        }
                ...
                if($row['property_status'] == 'selling'){
                  echo '<td class="crud-actions" '.$style.'>
                    <a href="'.site_url("admin").'/property/update/'.$row['id'].'" class="btn btn-info">Edit</a>
                    <a href="'.site_url("admin").'/property/delete/'.$row['id'].'" class="btn btn-danger">Delete</a>';
                    // echo $row['property_status']."<br/>";
                    // if($row['property_type'] == "selling" ){
                      echo ' <a onclick="fnopenpopup1('.$row['id'].')" class="btn btn-warning openpopup" title="This property is out of date">Withdraw</a>';
                    // }
                  echo "</td>";
                }else{
