    ...
    <div class="container top">
      ...
      <div class="page-header users-header">
        <h2>
          ...
          <a  href="<?php echo site_url("admin").'/'.$this->uri->segment(2); ?>/add?property_id=<?=$property_id?>" class="btn btn-success">Add a new</a>
        </h2>
      </div>
          ...
          <table class="table table-striped table-bordered table-condensed">
            ...
            <tbody>
              <?php
                ...
                echo "<tr><td><center><b>No Entry for Profit/Loss</center></b></td></tr>";
              }
              ?>      
            </tbody>
          </table>
