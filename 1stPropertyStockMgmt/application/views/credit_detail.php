		...
		<div class="resp-tabs-container">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" >
					...
					foreach($user_fund_log as $val){ ?>
					  <tr>
						<td align="right"><?php echo date ("d/m/Y", strtotime($val['date'])); ?></td>
						<td align="left"><?php echo $val['fund_type']; ?></td>
						<td align="left"><?php echo $val['detail']; ?></td>
					...
					<tr>
						...
						<td align="right"><span class="col-g"><?=$balance?></span></td>
					</tr>
				</table>
			           </div>
                              </div>
