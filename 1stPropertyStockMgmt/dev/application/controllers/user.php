 ...
 /**
    ...
    */
	...
	function my_profile_update()
	{
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            //$this->form_validation->set_rules('address', 'Address', 'trim|required');
              //$this->form_validation->set_rules('postalcode', 'Postal/Zip Code', 'trim|required');
	...
	function account()
	{
		...
		$this->form_validation->set_rules('phone', 'Phone number', 'trim|xss_clean|required|callback__check_phone');
		$this->form_validation->set_rules('address', 'Address', 'trim|required');
		...
		if($this->input->post('payment_type') == 'bank'){
			...
			$this->form_validation->set_rules('location', 'Payment Location', 'required');
		}
		...
		{			
			...
			if($amount==0 || $payment_type == 'bank')
			{
				...
				$newdata = array(
					...
					// echo 'http://myviko.pd.cisinlive.com/dev/paid?fname='.$fname.'&lname='.$lname.'&ic_number='.$ic_number.'&phone='.$phone.'&address='.$address.'&postalcode='.$postalcode.'&city='.$city.'&state='.$state.'&country='.$country.'&email='.$email.'&occupation='.$occupation.'&username='.$username.'&password='.$password.'&income='.$income.'&range='.$range.'&item_name_1='.$item_name_1.'&amount_1='.$amount_1.'';die;
					redirect('http://myviko.pd.cisinlive.com/dev/paid?fname='.$fname.'&lname='.$lname.'&ic_number='.$ic_number.'&phone='.$phone.'&address='.$address.'&postalcode='.$postalcode.'&city='.$city.'&state='.$state.'&country='.$country.'&email='.$email.'&occupation='.$occupation.'&username='.$username.'&password='.$password.'&income='.$income.'&range='.$range.'&item_name_1='.$item_name_1.'&amount_1='.$amount_1.'');   
					exit();
				}
			}
		}
