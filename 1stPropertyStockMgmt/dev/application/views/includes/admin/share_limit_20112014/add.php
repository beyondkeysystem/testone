      ...
      ?>
        <fieldset>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="" name="profit" value="<?php echo set_value('profit'); ?>" >
              <!--<span class="help-inline">Woohoo!</span>-->
            </div>
          </div>
           ...
           <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="" name="loss" value="<?php echo set_value('loss'); ?>" >
              <!--<span class="help-inline">Woohoo!</span>-->
            </div>
          </div>
            ...
            <div class="controls">
              <input type="text" id="" name="details" value="<?php echo set_value('details'); ?>" >
              <!--<span class="help-inline">Woohoo!</span>-->
            </div>
          </div>
