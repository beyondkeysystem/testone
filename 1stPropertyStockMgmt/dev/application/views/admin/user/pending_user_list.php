      ...
      <div class="page-header users-header">
        <h2>
         <?php $url2=$this->uri->segment(2);
          $url2=str_replace("_"," ",$url2);
          ?>
            <?php echo ucfirst($url2);?> for login
        </h2>
      </div>
      <div class="row">
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
                ...
                <th class="red header" style="width:210px">Action</th>
              </tr>
            </thead>
            <tbody>
              <?php
              ...
              <td class="crud-actions">
                  <a onclick="fnopenpopup('<?=$row['id']?>')" class="btn btn-info openpopup">Payment Details</a>
              </td>
                  <?php
                  echo '</tr>';
                  $i++;
  ...
  <?php
                ...
                echo '<table class="table table-striped table-bordered table-condensed">
                  <tbody>
                    <tr>
                      <td>
                        <center>No Registered Pending User</center>
                      </td>
                    </tr>
                  </tbody>
                </table>';
        ...
        <script>
            function fnopenpopup(obj){
                $.fancybox({ 
                        ...
                        'speedIn'       :350, 
                        'speedOut'      :350, 
                        'href'          :'/dev/admin_user/trans_log/'+obj,
                        'type'          : 'iframe',
                //         'onClosed' : function() {
                //             location.reload();
                //             return;
