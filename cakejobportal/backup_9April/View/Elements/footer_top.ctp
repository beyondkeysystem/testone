    ...
    <li class="Email-Add"><input type="text" class="email" placeholder="Email Address"/></li>
    <li class="browse">
    <div class="browse-btn"><input type="file" class="file">
	<div class="browse-input">Browse</div>
    </div>
    </li>
    <li><a class="btn btn-upload" href="#">Upload MY CV</a></li>
    </ul>
    </aside>
