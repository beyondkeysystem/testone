	...
	<?php	if(isset($pro_data['company_banner']))	{ ?>
	    ...
	    <?php } ?>
            ...
            <div class="content_tab ct_employer" id="horizontalTab">
                <ul>
                    <li><a href="#tab-1"><i class="fa fa-file-text"></i>Portfolio &amp; Articles</a></li>
                    <li><a href="#tab-2"><i class="fa fa-users"></i>Chat Room</a></li>
                    <li><a href="#tab-3"><i class="fa fa-comments"></i>Forum</a></li>
                    <li><a href="#tab-4"><i class="fa fa-envelope"></i>Messages</a></li>
                </ul>
