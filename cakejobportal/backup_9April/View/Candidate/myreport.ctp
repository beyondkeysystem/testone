<?php if (!empty($report_data)) { ?>
    <table  style="font-size: 14px;"class="gridtable"align="left" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <?php if (!empty($report_data)) { ?>    
            ...
            if (!empty($report_datas['Report']['created_date'])) {
                ...
                ?></td>
                    <td class="actions"><?php echo $this->Html->link(__('View Chart'), array('action' => 'chart', $report_datas['Report']['id'])); ?> <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $report_datas['Report']['id']), null, __('Are you sure you want to delete # %s?', $report_datas['Report']['id'])); ?></td></tr>
