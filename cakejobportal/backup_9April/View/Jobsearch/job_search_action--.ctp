					...
					<tr>
						<td width="782">
							<table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
								...
								<tr>
									<td><img src="<?php echo $this->webroot; ?>images/line.gif" width="772"></td>
								</tr>	
								<tr>
							  ...
							  ?>
								...
								<tr>
								  <td valign="top"><br><table width="95%" cellpadding="0" cellspacing="0" >
                                    <tr>
                                      <td align="right"><a href="#" onClick="return add_to_bookmark();"><img src="<?php echo $this->webroot; ?>images/bokmark_these_jobs.gif" border="0"></a></td>
                                    </tr>
                                  </table></td>
							  </tr>
