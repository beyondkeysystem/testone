                            ...
                            <td width="772" valign="top"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
                                ...
                                <tr>
                                  <td valign="top"><table width="100%" cellpadding="5" cellspacing="0">
                                      <tr>
                                        <td width="5"></td>
                                        <td width="98%">Search for the job seekers with namrecruit. </td>
                                      </tr>
                                  </table></td>
                                </tr>
                            </table></td>
                          ...
                          <tr>
                            <td align="left"><table width="800" cellpadding="5" cellspacing="0">
                              ...
                              <tr>
                                <td width="11">&nbsp;</td>
                                <td width="126">&nbsp;</td>
                                <td height="35" valign="middle"><a href="#" onClick="search_seekers();"><img src="../../images/search.gif" width="48" height="20" border="0"></a></td>
                              </tr>
                            </table></td>
                          </tr>
                          <tr align="center">
