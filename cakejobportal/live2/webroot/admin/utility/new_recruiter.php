<?  session_start();
	...
	{
		$rec_country = $_POST["business_country"];
	}	
	...
	function FillStates($selstate)
			{
			$con= new db();
			$str = "";
			$country="select * from job_state order by state_name desc";
			$result_country=$con->Executequery($country);		
			while($rs_subject=mysql_fetch_object($result_country))
			{
						
						$str.="<option value=".$rs_subject->state_id."^".$rs_subject->country_id."  >".$rs_subject->state_name."</option>";		
					}		
...
<body onLoad="showGoodcode('<?=$ctype?>');funSubmit('<?=$postal_region?>');other_city();MM_preloadImages('images/home1.gif','images/job_seekers1.gif','images/employers_admin1.gif','images/utility1.gif','images/signout1.gif')">
		...
		<form name="form1" action="" method="post"  enctype="multipart/form-data">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="700px" height="400" valign="top"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
                          ...
                          <tr>
                            <td height="55" class="headingRecRegister" > &nbsp;&nbsp;Add Recruiter </td>
                          </tr>
                          <tr>
                            <td valign="top" >&nbsp;&nbsp;&nbsp;&nbsp;You can add the recruiter here. </td>
                          </tr>
                          <tr>
                            <td >&nbsp;</td>
                          </tr>
                          ...
                          <? 	} ?>
                          <tr>
                            <td height="30" class="sectionRecheading" >Personal Information</td>
                          </tr>
                          <tr>
                            <td><img src="../images/line.gif" width="772"></td>
                          </tr>
                            ...
                            <td><table cellpadding="5" cellspacing="0" border="0" width="95%" align="center">
                                <tr>
                                  ...
                                  <td><input type="text" name="rec_name" id="rec_name" value="<? if (isset($_POST['rec_name'])) echo stripslashes($_POST['rec_name']); ?>">
                                      <img src="../../../images/star.gif" width="9" height="8"></td>
                                </tr>
                                <tr>
                                  <td>Company name </td>
            ...
            Recruiter</td>
                                ...
                                <tr style="display:none">
                                  ...
                                  <td><textarea name="rec_address" cols="30" rows="6"><? if (isset($_POST['rec_address'])) echo stripslashes($_POST['rec_address']); ?>
                        </textarea>
                                      <img src="../../images/star.gif"></td>
                                </tr>
                                <tr style="display:none">
                                  <td>Postal code</td>
                                  <td><input name="rec_postalcode" type="text" value="<? if (isset($_POST['rec_postalcode'])) echo stripslashes($_POST['rec_postalcode']); ?>" maxlength="15"></td>
                                </tr>
                                <tr style="display:none">
                                  <td>City or town </td>
                                ...
                                <tr>
											...
											<tr>
											  <td>Country</td>
											  <td><?=fill_dropdown('business_country','job_country', 'country_name', "country_id", $rec_country, "Country","")?>
                                                <img src="../../images/star.gif"></td>
									  </tr>
                                <tr>
                                  <td colspan="2" align="left">&nbsp;</td>
                                ...
                                <tr>
                                  <td colspan="2" align="left"><p class="medium_black">Postal Address:</p></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td>Country</td>
                                  <td><?=fill_dropdown('postal_country','job_country', 'country_name', "country_id", $postal_country, "Country","","onchange=funSubmit('".$postal_region."');"); ?>
                                      <img src="../../images/star.gif"></td>
                                </tr>
                                <tr>
                                  <td>Region</td>
                                  <td><input type="hidden"  name="rec_state" value="<?=$rec_state?>">
                                      ...
                                      <input name="postal_region1" type="text" value="<? if (isset($_POST['postal_region1'])) echo stripslashes($_POST['postal_region1']); ?>" id="postal_region1" style="display:none " >
                                      <select name="seeker_state1" id="seeker_state1" class="input_textarea" style="display:none">
                                        <? FillStates($postal_region)?>
                                      </select>
                                      </span><span id="states"> </span><img src="../../images/star.gif"> <span id="span_other_region" <? if (!isset($_POST['other_region']) or $postal_region!=16){?>style="display:none"<? } ?> >&nbsp;&nbsp;&nbsp;&nbsp;Please specify other region :
                          ...
                          <tr>
                            <td height="30" class="sectionRecheading" >Contact Information</td>
                          </tr>
                          <tr>
                            <td><img src="../images/line.gif" width="772"></td>
                          </tr>
                          ...
                          <tr>
                            <td valign="top"><table cellpadding="5" cellspacing="0" border="0" width="95%" align="center">
                                <tr>
                                  <td  > VAT Reg No </td>
                                  <td  ><input name="rec_vat_regno" type="text" id="rec_vat_regno" value="<? if (isset($_POST['rec_vat_regno'])) echo stripslashes($_POST['rec_vat_regno']);  ?>" >
                                      <img src="../../images/star.gif"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td>Email address </td>
                                  <td><input name="rec_email" type="text" value="<? if (isset($_POST['rec_email'])) echo stripslashes($_POST['rec_email']); ?>" size="40" >
                                      <img src="../../images/star.gif">&nbsp;&nbsp;<span class="error" id="email_exists"></span></td>
                                </tr>
                                <tr>
                                  <td>Web address </td>
                                  <td><input name="rec_web" type="text" value="<? if (isset($_POST['rec_web'])) echo stripslashes($_POST['rec_web']); ?>" size="40">
                                  </td>
                                </tr>
                                <?
												if($comp_logo != "")
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td class="comment"><img src="logos/<?=$comp_logo?>">
                                      <input type="checkbox" name="chkLogo">
                                      Delete Logo</td>
                                </tr>
                                <?
											 	}
...
&nbsp;&nbsp;Size : 180px X 80px</td>
                                ...
                                <tr>
                                  <td colspan="2" class="comment" >Use the checkboxes below to indicate information you would like to hide from jobseekers. Any information that you do NOT want to provoide to potential employees should be checked. </td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                  <td><input type="checkbox" name="rec_hidename" value="1" <? if (isset($_POST['rec_hidename']) ) echo ("checked"); ?>>
            Hide contact name<br>
            <input type="checkbox" name="rec_hideaddress" value="1" <? if (isset($_POST['rec_hideaddress']) ) echo ("checked"); ?>>
            ...
            <input type="checkbox" name="rec_hidecity" value="1" <? if (isset($_POST['rec_hidecity']) ) echo ("checked"); ?>>
            Hide location<br>
            ...
            Hide telephone number <br>
                          ...
                          <tr>
                            <td height="30" class="sectionRecheading" >Login Information</td>
                          </tr>
                          <tr>
                            <td><img src="../images/line.gif" width="772"></td>
                          </tr>
                          ...
                          <tr>
                            <td><table cellpadding="5" cellspacing="0" border="0" width="95%" align="center">
                                <tr>
                                  <td   colspan="2" class="comment">Creat a password for your account. Your user ID will be your email address.</td>
                                </tr>
                                <tr>
                          ...
                          <tr>
                            <td height="30" class="sectionRecheading" >Where did you hear about NamRecruit?</td>
                          </tr>
                          <tr>
                            <td><img src="../images/line.gif" width="772"></td>
                          </tr>
                          ...
                          <tr>
                            <td><table cellpadding="5" cellspacing="0" border="0" width="98%" align="center">
                                <tr>
                                  <td   colspan="2"><input type="checkbox" name="email" value="1" <? if (isset($_POST['email']) ) echo ("checked"); ?>>
            Email&nbsp;&nbsp;
            ...
            Other&nbsp;&nbsp; </td>
                          ...
                          <tr>
                            <td height="30" class="sectionRecheading" >Terms and Conditions </td>
                          </tr>
                          <tr>
                            <td><img src="../images/line.gif" width="772"></td>
                          </tr>
            ...
            I confirm that I have read and agree with the NamRecruit Good <a href="../code-of-practice.php" class="terms">Code of Practice</a>. </td>
                                ...
                                <tr>
                                  <td   colspan="2"><input name="rec_terms" type="checkbox" id="terms" value="1" <? if (isset($_POST['rec_terms']) ) echo ("checked"); ?>>
            I confirm that I have read and agree with the <a href="../terms.php" class="terms">Term & Conditions</a> of the NamRecruit website. </td>
                          ...
                          <tr>
                            <td height="50"><table cellpadding="5" cellspacing="0" border="0" width="90%" align="center">
                                <tr>
                                  <td align="right" ><img src="../../images/preview.gif" width="102" height="24" border="0" style="cursor:pointer" onClick="previewform();"> </td>
                                  <td><img src="../../images/submit_registration.gif" width="141" height="24" border="0" style="cursor:pointer" onClick="submitform();"> </td>
                                </tr>
                            </table></td>
                          </tr>
                        </table></td>						
