...
<body>
  ...
  <header class="header">
    ...
    <li class="sub-menu">    
      <a href="#"><i class="fa fa-lock"></i></a><a href="/users/signup">Sign Up</a>        
    </li>
    <li>
      <a href="/users/login"><i class="fa fa-power-off"></i>Log in</a>    </li>
    <?php }else{ ?>
    <li class="sub-menu">
    <a href="#"><i class="fa fa-power-off"></i></a><a href="/users/logout">Logout</a>        
    </li>
    <?php }?>
    </ul>
    </aside>
      ...
      <div class="container-fluid">
        ...
        <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="/<?php echo $ure[0]; ?>/">Home</a></li>
            <li><a href="#">Daily Deals</a></li>
            <li><a href="#">Help / Report Abuse</a></li>
            <li><a href="#">Knowledge Room</a></li>
            <li><a href="/<?php echo $ure[0]; ?>/">Employer</a></li>
            <li><a href="/<?php echo $ure[0]; ?>/">Candidates</a></li>
            <li><a href="/<?php echo $ure[0]; ?>/contact">Contact Us</a></li>
          </ul>
...
<?php
   ...
   $fluxuser_id=0;
   header('Location: http://'.$_SERVER['SERVER_NAME'].'/users/login');
}
?>
