<script type="text/javascript">
	function insert_chat(to,from,e)
	{
		...
		$.ajax({
		 type:'post',
		 url:'/cakejobportal/im/public_chatting',
...
<style>
	...
	#fm_chat_content{width:95%;font-size:13px;text-align: left;padding:10px;overflow-y:scroll;height: 500px; min-height: 500px;}
	...
	<center>
		...
		<div id="chatting_window">
			<div id="chatting_user">
				You are chatting with <span class="username"><a href="film_maker_reel.php?id=<?php echo $u_unique_id;?>"><?php echo $u_fname.' '.$u_lname;?></a></span>
			</div>
