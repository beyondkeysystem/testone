...
<div class="inpt_area">
    ...
    <?php //echo $city_dropbox; ?>
    <input type="text" name="business_city" value="<? if (isset($_POST['business_city'])) echo stripslashes($_POST['business_city']); else echo($rsseeker->seeker_business_city);?>">
</div>
<div class="inpt_area">
    <label>Country:</label>
    <?=$country_drop?>
...
<div class="inpt_area">
    <label>City or town:</label>
    <?php //echo $postal_city_dropbox; ?>
    <input type="text" name="postal_city" value="<? if (isset($_POST['postal_city'])) echo stripslashes($_POST['postal_city']); else echo($rsseeker->seeker_postal_city);?>">
</div>
<div class="inpt_area">
    <label>Country:</label>
    <?=$postal_country_drop?>
...
<p class="come-join" >Candidate Banner Detail</p>
 <div class="greyline"></div>
