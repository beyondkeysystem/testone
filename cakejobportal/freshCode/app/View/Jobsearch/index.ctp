          ...
          <div class="profile_content">
			...
			<div class="inpt_area">
			   ...
			   <?php //echo $seeker_jobcity_drop; ?>
				...
				<option value="Volunteer/Unpaid" <?php if(isset($vacancy) AND trim($vacancy)=="Volunteer/Unpaid"){ echo "selected";} ?> ><?php echo 'Volunteer/Unpaid'; ?></option>
				<option value="Internship/Apprenticeships" <?php if(isset($vacancy) AND trim($vacancy)=="Internship/Apprenticeships"){ echo "selected";} ?> ><?php echo 'Internship/Apprenticeships'; ?></option>
			      </select>
                            </div>
                            <div class="salary">
		      ...
		      <div class="advance_search">
				...
				<option value="Internship/Apprenticeships" <?php if(isset($vacancy) AND trim($vacancy)=="Internship/Apprenticeships"){ echo "selected";} ?> ><?php echo 'Internship/Apprenticeships'; ?></option>
					...
					<input type="text" value="" name="holdfield" />
					    ...
					    <option value="company_name">Company</option>
                                ...
                                <div class="inpt_area">
                                	  ...
                                	  <input type="radio" name="off_package4" value="Annual" id="radio1" class="css-checkbox" />
                                        <label for="radio1" class="css-label">Annually</label>
...
<input type="text" value="" name="seeker_salary_from" placeholder="minimum" />
                                         <!-- <select class="select" tabindex="1" name="seeker_salary_from">
                                            <option value="">Minimum Salary</option>
                                            <option value="15000">5000</option>
					    <option value="15000">14000</option>
                                            <option value="20000">19000</option>
                                            <option value="25000">24000</option>
                                            <option value="30000">29000</option>
                                            <option value="35000">34000</option>                                                                                     
                                          </select>--> 
                                        </div> 
                                        <div class="salary-range">
<input type="text" value="" placeholder="maximum" name="seeker_salary_to" />
