      ...
      <div class="container-fluid">
        ...
        <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<?=$this->webroot?>users/comingsoon">Daily Deals</a></li>
            <li><a href="<?=$this->webroot?>users/comingsoon">Help / Report Abuse</a></li>
            <li><a href="<?=$this->webroot?>users/comingsoon">Knowledge Room</a></li>
