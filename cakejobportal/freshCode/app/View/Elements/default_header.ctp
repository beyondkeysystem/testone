...
<script>
   setTimeout(function(){$("#flashMessage").hide('slow');},3000);   
</script>
<?php
...
<header class="header">
    ...
    <ul class="top-buttons pull-right"  id="horizontalmenu">
      <?php if(!empty($user)) {  ?>
    <li><a href="#"><i class="fa fa-link"></i></a><?php echo $this->Html->link(__('Upgrade link'), array('controller' => 'upgrade', 'action' => 'index')); ?></li>
    <?php }?>
...
if(!empty($user)) {  ?>
   <li class="sub-menu">
		...
		<?php
if(isset($note_count) AND $note_count > 0 ) {
			 ...
			 <div style="">
                                    <div class="noty-manager-list-item noty-manager-list-item-information">
                                        <div class="activity-item">
                                            ...
                                            <div class="activity">
						<?php echo $this->Html->link(__($note_data['alert']), array('controller' => 'upgrade', 'action' => 'index')); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php } ?>
  ...
  //  pr($user);
   ...
   <?php  } ?>
    ...
    <form class="form-search" method="post" action="<?=$this->webroot?>home/searchheader">
    <input type="text" name="shead" placeholder="What are you looking for?" />
    ...
    <section><span><?=$this->Session->flash()?></span></section>
