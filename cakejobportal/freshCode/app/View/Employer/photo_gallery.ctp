...
<ul class="gallery-top-menu">
   <li><a href="<?php echo $this->webroot; ?>employer/video_gallery"><i class="fa fa-film"></i>Videos Gallery</a></li>
   <li><a class="gallery-active" href="<?php echo $this->webroot; ?>employer/photo_gallery"><i class="fa fa-picture-o"></i>Photos Gallery</a></li>
   ...
   <div class="clearfix"></div>
            <div class="profile_content">
            	<h2><?php if(isset($photo_gallery['PhotoGallery']['parent_title'])) { echo $photo_gallery['PhotoGallery']['parent_title'];  } ?></h2>
                <div class="orng_dvdr"></div>
                <div class="profile_c">
               
   <div class="gallery-video">
    <?php if(isset($photo_gallery['PhotoGallery']['parent_video_image'])) {  ?>
        <a title="Dummy Title Video" href="<?php echo $this->webroot; ?>uploads/gallery/<?php echo $photo_gallery['PhotoGallery']['parent_video_url']; ?>" class="youtube cboxElement"><img src="<?php echo $this->webroot; ?>uploads/gallery/<?php  echo $photo_gallery['PhotoGallery']['parent_video_image']; ?>" alt="" /></a>
        
    <?php } ?>
   </div>
   
   <ul class="gallery-thumb">
      <li><a class="youtube cboxElement" href="<?php echo $this->webroot; ?>uploads/gallery/<?php echo $photo_gallery['PhotoGallery']['child_video_url1']; ?>"><img src="<?php echo $this->webroot; ?>uploads/gallery/<?php echo $photo_gallery['PhotoGallery']['child_video_image1']; ?>" alt=""/><span><?php if(isset($photo_gallery['PhotoGallery']['child_title_one'])) { echo $photo_gallery['PhotoGallery']['child_title_one'];  } ?></span></a></li>
      <li><a class="youtube cboxElement" href="<?php echo $this->webroot; ?>uploads/gallery/<?php echo $photo_gallery['PhotoGallery']['child_video_url2']; ?>"><img src="<?php echo $this->webroot; ?>uploads/gallery/<?php echo $photo_gallery['PhotoGallery']['child_video_image2']; ?>" alt=""/><span> <?php if(isset($photo_gallery['PhotoGallery']['child_title_two'])) { echo $photo_gallery['PhotoGallery']['child_title_two'];  } ?></span></a></li>
      <li><a class="youtube cboxElement"  href="<?php echo $this->webroot; ?>uploads/gallery/<?php echo $photo_gallery['PhotoGallery']['child_video_url3']; ?>"><img src="<?php echo $this->webroot; ?>uploads/gallery/<?php echo $photo_gallery['PhotoGallery']['child_video_image3']; ?>" alt=""/><span> <?php if(isset($photo_gallery['PhotoGallery']['child_title_three'])) { echo $photo_gallery['PhotoGallery']['child_title_three'];  } ?></span></a></li>
      <li><a class="youtube cboxElement"  href="<?php echo $this->webroot; ?>uploads/gallery/<?php echo $photo_gallery['PhotoGallery']['child_video_url4']; ?>"><img src="<?php echo $this->webroot; ?>uploads/gallery/<?php echo $photo_gallery['PhotoGallery']['child_video_image4']; ?>" alt=""/><span> <?php if(isset($photo_gallery['PhotoGallery']['child_title_four'])) { echo $photo_gallery['PhotoGallery']['child_title_four'];  } ?> </span></a></li>
   </ul>
