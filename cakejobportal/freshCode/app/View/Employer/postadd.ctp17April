...
<div class="inpt_area">
	...
	<input name="salary_from" type="text" id="salary_from" value="" class="inputfield width11" />
	<label for="f_name">Salary To :</label>
	<input name="salary_to" type="text" id="salary_to" value=""  class="inputfield width11" />
</div>
<div class="inpt_area">
...
<div class="inpt_area">
	...
	<input name="currency" value="" type="text" class="inputfield width11"/>
</div>
<div class="inpt_area">
...
<div class="inpt_area">
	...
	<input type="text" name="ques[]" id="ques1"  class="inputfield" value="Example: Do you have a Code BE Drivers Lincence?" onFocus="clearText3(this);">
</div> 
<div class="inpt_area">
	<label for="f_name">Question 2:</label>
	<input type="text" name="ques[]" id="ques1"  class="inputfield" value="Example: Do you have Accpacc experience?" onFocus="clearText4(this);">
</div> 
<div class="inpt_area">
	<label for="f_name">Question 3:</label>
	<input type="text" name="ques[]" id="ques1" class="inputfield">
</div> 
<div class="inpt_area">
