...
<ul class="gallery-top-menu">
   <li><a class="gallery-active" href="<?php echo $this->webroot; ?>employer/video_gallery"><i class="fa fa-film"></i>Videos Gallery</a></li>
   <li><a href="<?php echo $this->webroot; ?>employer/photo_gallery"><i class="fa fa-picture-o"></i>Photos Gallery</a></li>
...
<?php if(isset($video_gallery['VideoGallery']['parent_title'])) {  ?>
            	<h2><?php echo $video_gallery['VideoGallery']['parent_title']; ?></h2>
<?php } ?>
   ...
   <ul class="gallery-thumb">
      <li><a class="youtube cboxElement play-small" href="<?php echo $video_gallery['VideoGallery']['child_video_url1']; ?>"><img src="<?php echo $this->webroot; ?>css/images/play_btn_small.png" alt=""/></a><img src="<?php echo $this->webroot; ?>uploads/gallery/<?php echo $video_gallery['VideoGallery']['child_video_image1']; ?>" alt=""/><span> <?php if(isset($video_gallery['VideoGallery']['child_title_one'])) { echo $video_gallery['VideoGallery']['child_title_one'];  } ?></span></li>
      <li><a class="youtube cboxElement play-small" href="<?php echo $video_gallery['VideoGallery']['child_video_url2']; ?>"><img src="<?php echo $this->webroot; ?>css/images/play_btn_small.png" alt=""/></a><img src="<?php echo $this->webroot; ?>uploads/gallery/<?php echo $video_gallery['VideoGallery']['child_video_image2']; ?>" alt=""/><span> <?php if(isset($video_gallery['VideoGallery']['child_title_two'])) { echo $video_gallery['VideoGallery']['child_title_two'];  }?></span> </li>
      <li><a class="youtube cboxElement play-small"  href="<?php echo $video_gallery['VideoGallery']['child_video_url3']; ?>"><img src="<?php echo $this->webroot; ?>css/images/play_btn_small.png" alt=""/></a><img src="<?php echo $this->webroot; ?>uploads/gallery/<?php echo $video_gallery['VideoGallery']['child_video_image3']; ?>" alt=""/><span> <?php if(isset($video_gallery['VideoGallery']['child_title_three'])) { echo $video_gallery['VideoGallery']['child_title_three'];  }?></span></li>
      <li><a class="youtube cboxElement play-small"  href="<?php echo $video_gallery['VideoGallery']['child_video_url4']; ?>"><img src="<?php echo $this->webroot; ?>css/images/play_btn_small.png" alt=""/></a><img src="<?php echo $this->webroot; ?>uploads/gallery/<?php echo $video_gallery['VideoGallery']['child_video_image4']; ?>" alt=""/><span> <?php if(isset($video_gallery['VideoGallery']['child_title_four'])) { echo $video_gallery['VideoGallery']['child_title_four'];  }?> </span></li>
   </ul>
