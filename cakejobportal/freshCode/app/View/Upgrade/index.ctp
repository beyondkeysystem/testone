...
<?php }else{ ?>
<p class="come-join">Come Join and choose our Upgrade Plan and be a part of Recruit Young?s Online Community, where we hope to <span class="yellow-txt">inspire, innovate, </span>and <span class="yellow-txt">Empower Youth.</span></p>
<?php }?>
