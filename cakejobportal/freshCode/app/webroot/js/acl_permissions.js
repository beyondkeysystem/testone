...
AclPermissions.permissionToggle = function() {
	...
	$('img.permission-toggle').click(function() {
		...
		// show loader
		$this.attr('src','http://'+ document.domain +'/kevin3b29june/img/ajax/circle_ball.gif');

		// prepare loadUrl
		var loadUrl = 'http://'+ document.domain +'/kevin3b29june/admin/acl/acl_permissions/toggle/';
		loadUrl    += acoId+'/'+aroId+'/';
