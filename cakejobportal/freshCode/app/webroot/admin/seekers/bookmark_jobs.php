                          ...
                          <tr>
                            <td valign="top"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="100%" >
                              <tr>
                                ...
                                <tr>
                                  <td width="73%" height="30" class="heading_black" >&nbsp;Job Bookmarks </td>
                                  <td width="27%" align="right" class="heading_black" >&nbsp;</td>
                                </tr>
                                <tr>
                                  <td colspan="2" valign="top"><table width="100%" cellpadding="5" cellspacing="0">
                                      <tr>
                                        <td>&nbsp;&nbsp;&nbsp;A list of all the job bookmarks by <?=$rstemp->seeker_name?> <?=$rstemp->seeker_surname?> (Seeker ID : <?=$rstemp->seeker_id?>).</td>
                                      </tr>
                                      <tr>
                                        <td width="98%">
									  ...
									  <tr>
										...
										<td width="95%" class="star">No Job Bookmarks Found. </td>
									  </tr>
									  <tr>
										<td>&nbsp;</td>
									  </tr>
							...
							<table width="90%" cellpadding="6" cellspacing="0" class="table_black_border">
							  ...
							  ?>
                                  <tr align="left">
                                    ...
                                    <td width="19%" class="<?=$td_class?>"><a href="#" class="link_dark_blue">
