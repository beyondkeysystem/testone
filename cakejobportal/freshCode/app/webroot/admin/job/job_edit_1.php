...
<table width="990" border="0" align="center" cellpadding="0" cellspacing="0">
     ...
     <tr>
         <td class="whitebgcolor"><form name="form1" action="job_edit_1.php?ad_id=<?=$rsJob->ad_id?>" method="post" enctype="multipart/form-data" target="postProcess"  >
           <input type="hidden" name="ad_id" value="<?=$rsJob->ad_id?>">
		    <input type="hidden" name="rec_id" value="<?=$rsComp->rec_id?>">
		   <input type="hidden" name="hurl" value="job_edit_1.php">
           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="4">
             ...
             <tr>
               <td width="812"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
                   
                   <tr>
                     <td valign="top"><table width="100%" cellpadding="5" cellspacing="0">
                         <tr>
                           <td width="7">&nbsp;</td>
                           <td colspan="2"> You can update this job advert here.</td>
                         </tr>
                         <tr>
                         ...
                         <tr>
                           ...
                           <td width="564" colspan="2" class="comment"><input type="text" name="company_name" id="company_name" value="<?=$company_name?>" readonly>
                               <img src="../../images/star.gif"></td>
                         </tr>
                         <tr>
                           <td>&nbsp;</td>
                           <td width="181" valign="top">Company Description </td>
                           <td colspan="2" class="comment"><textarea  name="company_desc" cols="30" rows="6"  onkeyup="showLeftChars();document.getElementById('chars_left').innerHTML=(120-this.value.length); if(this.value.length>120) {document.getElementById('chars_left').innerHTML='Fewer than 0'; this.value = this.value.substring(0,120);}" readonly><?=$company_desc?>
         </textarea>
                         ...
                         <tr>
                           ...
                           <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                               ...
                               <tr>
                                 ...
                                 <td width="6%"><input type="checkbox" name="hide1" <? if($hide1=="1"){ echo("checked");} ?> id="hide1" value="1"></td>
                               </tr>
                               <tr>
               ...
               <td colspan="2"><table width="100%" cellpadding="5" cellspacing="0">
                   ...
                   <tr>
                     ...
                     <td colspan="3" valign="top"><p>
                       ...
                       <input type="radio" name="option" id="radio3" value="2"  <? if(isset($_POST["option"]) && $_POST["option"]=="2"){  echo("checked"); } else if($rsJob->option_radio=="2"){  echo("checked"); }?>>
                       Email to internal staff members only (intercompany ad), or<br>
                       <input type="radio" name="option" id="radio4" value="3"  <? if(isset($_POST["option"]) && $_POST["option"]=="3"){  echo("checked"); } else if($rsJob->option_radio=="3"){  echo("checked"); }?>>
                       ...
                       <br />
                         <div>If you have a printed ad, you can upload it in PDF or JPEG here: 
                           (Note: This will appear on your job ad as a link so jobseekers can view it online) <br/>
                           <br />
                   ...
                   <tr>
                     <td>&nbsp;</td>
                     <td colspan="3"><input name="send_mail_another" type="checkbox" onChange="send_mail_to_another(this);" id="send_mail_another" value="1" <? if($confirm_mail == "1") echo "checked" ?>>
                   ...
                   <tr>
					 ...
					 <img src="../images/back.gif" width="53" height="20" border="0" onClick="goBack('<?=$redirectUrl?>');" style="cursor:pointer">
                       &nbsp;&nbsp;&nbsp; <img src="../../images/update.gif" width="60" height="22" border="0" onClick="edit_job_ad_1(document.form1);" style="cursor:pointer"> </td>
                   </tr>
               </table></td>
             </tr>
           </table>
