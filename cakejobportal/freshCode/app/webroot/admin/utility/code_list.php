<?  session_start();
	...
	$sqladvert = "select * from  job_voucher_code order by code_id desc";
...
<script language="javascript">
 ...
 function deletebanner(vid)
 {
 	if(confirm("Are you sure you want to delete this code?"))
	{
		document.form1.method="post";
		document.form1.action="banner_delete.php?delCode=delete&vid="+vid;
						...
						<td width="700px" height="400" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                          ...
                          <tr>
                            <td width="772" valign="top"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
                              <tr>
                                <td width="73%" height="30" class="headingRegister" >&nbsp;<span class="heading_black"> Voucher Code List</span></td>
                                ...
                                <tr>
                                  <td colspan="2" valign="top"><table width="100%" cellpadding="5" cellspacing="0">
                                      <tr>
                                        <td width="5"></td>
                                        <td width="98%">A list of the namrecruit voucher codes. </td>
                                      </tr>
                                  </table></td>
                                </tr>
                            </table></td>
							 ...
							 ?>
							  ...
							  <tr>
                                <td align="center"><table width="95%" cellpadding="6" cellspacing="0" class="table_black_border">
                                    <tr align="left">
                                      <td class="table_head">Voucher Code </td>
                                      <td class="table_head">Expiry Date</td>
							  ...
							  ?>
                                    <tr align="left">
                                      <td width="25%" class="<?=$td_class?>"><?=$rsadvert->voucher_code  ?></td>
                                      <td width="33%" class="<?=$td_class?>"><? list($year, $month, $day) = explode("-",$rsadvert->expiry_date);
	//$date = "".$day."/".$month."/".$year;
	 $date = date("M d, Y", mktime(0, 0, 0, $month, $day , $year)) ;?><?=$date?></td>
                                      <td width="17%" class="<?=$td_class?>"><?=showStatus('code','code_id',$rsadvert->code_id,'status',$rsadvert->status,'job_voucher_code'); ?></td>
                                      <td width="25%" class="<?=$td_class?>_end"><a href="code_add.php?action=edit&vid=<?=$rsadvert->code_id?>" class="paging_text">Edit</a> &nbsp;&nbsp;&nbsp;<a href="#" class="paging_text" onClick="return deletebanner(<?=$rsadvert->code_id?>)">Delete </a></td>
                                    </tr>
                                    <?
									$i++;
								}
