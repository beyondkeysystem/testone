...
&nbsp;<br>
            <br>
            <span class="normal_text">Additional Jobs &nbsp;</span> &nbsp;
            <? if($vat>0) {?>
            <br>
            <br>
            ...
            <? }?>
                                      ...
                                      <? if($rsInvoice->additional_job >0) {?>
                                      <td width="17%" valign="bottom"  ><?=$rsInvoice->additional_job?>
                            &nbsp;<br>
                                        <? if($vat>0) {?>
                                        <br>
                                        <br>
                                      ...
                                      <td width="23%" valign="top" class="normal_text"  >N$
                                          <?=number_format($rsInvoice->rate-$rsInvoice->additional_job_rate-$rsInvoice->vat,2)?>
                                          <br>
                                          <br>
            N$
            <?=number_format($rsInvoice->additional_job_rate,2)?>
            <? if($vat>0) {?>
            <br>
            <br>
            N$
                            ...
                            <td width="79%" align="left" valign="top"><table  width="100%" id="pay_eft"  >
                                <tr>
                                  <td> To make payment by Online Booking, please transfer funds electronically to:<br>
                                      <br>
										Account Name : NAMRECUIT <br>
										Account Number : 62241932856 <br>
										Bank Name : First National Bank Namibia<br>
										Branch Code : 282272<br>
										Branch Name : SME Business Unit<br>
										...
										<br>
										Once your payment has cleared your account will be upgraded. 
									</td>
                                </tr>
                              </table>
