                          ...
                          <tr>
							...
							<form name="form1" action="" method="post"  enctype="multipart/form-data">
							  <table width="900" border="0" align="left" cellpadding="8" cellspacing="0" class="table_black_border">
                                ...
                                <tr>
                                  ...
                                  <?
											for($i=1; $i<mysql_num_rows($resultPlan); $i++) 
											{
												...
												if($f==0){
												if($$rsPlan->number_job!="0")
												{
												?>
                                  <td class="td_border_right"><span class="error">
                                    <?=$$rsPlan->number_job?>
                                  </span></td>
                                  <?
												}else {?>
                                  <td class="td_border_right"><span class="error">Unlimited</span></td>
                                  <?		}
												}
												else
												{
                                  ...
                                  <? } else {?>
                                  <td ><span class="error">Unlimited</span></td>
                                  <?
                                ...
                                <tr>
                                  ...
                                  <td valign="top" class="td_border_bottom_right"><span class="normal_text">
                                    <?
															if($$rsPlan->rate == 0)													
															{
																echo "Post 1 job per month.";
															}
															else 
															{
																if($$rsPlan->number_job!="0"){ $pp=$$rsPlan->number_job; }else { $pp="Unlimited";}
																echo "N$ " . number_format($$rsPlan->rate,2,"-","") . " per month for " . $pp . " job posting.";
															}
														?>
                                  </span> </td>
                                  <?
                                ...
                                <tr>
                                  <td valign="top" class="td_border_right">Purchase additional job ads</td>
                                  <?
												for($i=1; $i<mysql_num_rows($resultPlan); $i++) 
												{
													$rsPlan = "rsPlan" . $i;
                                  ...
                                  <td align="left" valign="top"  class="td_border_right"><span class="normal_text">
                                    <?
															if($$rsPlan->rate == 0)													
															{
																echo "N$ " . number_format($$rsPlan->rate_per_job,2,'-','') . " per additional job ad per month.";
																
															}												  
															else
															{
																if($$rsPlan->number_job!=0){
																echo "N$ " . number_format($$rsPlan->  	rate_per_job,2,'-','') . " per additional job posting above " . $$rsPlan->number_job . " job posted per month.";														}else {
																echo "&nbsp;";														}
                                ...
                                <tr>
                                  <td align="left" valign="top" class="td_border_bottom_right">&nbsp;<span class="blue_big_style">Select additional job ads <img src="../images/tip.gif" alt="Tip" width="26" height="25" hspace="10" onClick="MM_popupMsg('You can add the additional jobs presant in plan by selecting number of jobs from dropdown.')"></span></td>
                                  <?
												for($i=1; $i<mysql_num_rows($resultPlan); $i++) 
												{
													$rsPlan = "rsPlan" . $i;
                                  ...
                                  <td align="left" valign="top"  class="td_border_bottom_right"><span class="normal_text">
                                    <? if($$rsPlan->number_job>0)
									{?>
      Add <SPAN style="FONT-SIZE: 10pt; COLOR: #000000; FONT-FAMILY: Verdana"><FONT class=normaltext>Job Ads</FONT></SPAN> :
      <select name="add_<?=$$rsPlan->plan_id?>" onChange="countTot(this,<?=$$rsPlan->plan_id?>,<?=$$rsPlan->rate_per_job?>,<?=$$rsPlan->rate?>)" >
        <? for($j=0;$j<=10;$j++) {?>
        <option value="<?=$j?>">
        <?=$j?>
        </option>
      ...
      <? } else { echo "&nbsp;&nbsp;&nbsp;"; }?>
                                ...
                                <tr>
                                  ...
                                  <?
									...
									?>
                                  <td align="left" valign="top"  class="td_border_bottom_right"><span class="normal_text">
                                    <div id="tot_<?=$$rsPlan->plan_id?>" align="center" class="blue_big_style">N$
                                        <?=$$rsPlan->rate?>
                                    </div>
                                    </span><br>
                                    <center>
                                ...
                                <tr>
                                  <td valign="top" class="td_border_bottom_right">&nbsp;</td>
                                  <?
												for($i=1; $i<mysql_num_rows($resultPlan); $i++) 
												{
													$rsPlan = "rsPlan" . $i;
											?>
                                  <td align="left" valign="top"  class="td_border_bottom_right"><span class="normal_text"> </span><br>
                                      <br>
                                      <center>
                                        <img src="../../images/sign_up_now.gif" width="102" height="24" border="0" onClick="submitform(<?=$_GET['rec_id']?>,<?=$$rsPlan->plan_id?>);">
                                                                          </center></td>
                                  <?
												}
												...
												$rsPlan = "rsPlan" . $i;
											?>
                                  <td align="left" valign="top" class="td_border_bottom"><span class="normal_text"> </span><br>
                                      <br>
                                      <center>
                                        <img src="../../images/sign_up_now.gif" width="102" height="24" border="0" onClick="submitform(<?=$_GET['rec_id']?>,<?=$$rsPlan->plan_id?>);">
                                                                          </center></td>
