<?  session_start();
	...
	$objDb = new db();
	$rowCount=0;
	$sqlPaid = "select * from  job_rec_payments where paid_by='Cheque' and (pay_status=3 or pay_status=4)  order by pay_id desc";
...
<script language="javascript" type="text/javascript">
	function viewDetails(location)
	{
		...
		document.form1.action = location + "&url=cheque_bounce.php&urlPage=<?=$cPage?>";
		document.form1.submit();
	}
	function chequeDetails(pay_id)
	{
		document.form1.method="post";	
		document.form1.action = "cheque_detail.php?pay_id=" + pay_id + "&url=cheque_bounce.php&urlPage=<?=$cPage?>";
		document.form1.submit();
	}
	function paging(pageno)
	 {
		 document.form1.method = "post";
		 document.form1.action = "cheque_bounce.php?cPage=" + pageno;
		 document.form1.submit();
	 }
						...
						<td width="700px" height="400" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                          ...
                          <tr>
                            <td width="772" valign="top"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
                              <tr>
                                <td width="73%" height="30" class="headingRegister" >&nbsp;<span class="heading_black">  Bounce/Not Received Cheque  List</span></td>
                                ...
                                <tr>
                                  <td colspan="2" valign="top"><table width="100%" cellpadding="5" cellspacing="0">
                                      ...
                                      <tr>
                                        <td width="5"></td>
                                        <td width="98%">A list of all Bounce or Not Received cheques.
									</td>
                          ...
                          <tr>
							...
							?>
							  ...
							  ?>
                                  <tr align="left">
                                    <td width="14%" class="<?=$td_class?>"><a href="#" onClick="chequeDetails(<?=$rsPaid->pay_id?>);" class="blue_title_small" title="Click to view cheque details."><?=$rsPaid->cheque_number?></a></td>
                                    <td width="12%" class="<?=$td_class?>"><?=getDateValue($rsPaid->bounce_date);?>&nbsp;</td>
                                    <td width="14%" class="<?=$td_class?>"><?=sprintf("%05d",$rsPaid->pay_id) ?>&nbsp;</td>
                                    <td width="13%" class="<?=$td_class?>"><a href="#" onClick="viewDetails('invoice_details.php?invoice_id=<?=$rsPaid->invoice_id?>');" class="paging_text" title="Click to view invoice details.">
                                    ...
                                    <td width="14%" class="<?=$td_class?>_end" ><span class="text_gray_bold">&nbsp;&nbsp;<? if($rsPaid->pay_status==3) { echo("Bounce"); }else if($rsPaid->pay_status==4) { echo("Not Received"); }?>
                                   </span>
					  ...
					  <tr>
						...
						<table width="100%" cellpadding="2" cellspacing="0">
							  <tr>
								...
								<td width="95%" class="star">No Bounce/Not Received Cheques Found.</td>
							  </tr>
							  <tr>
								<td>&nbsp;</td>
							  </tr>
