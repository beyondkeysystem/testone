...
<script language="javascript" type="text/javascript">
	...
	{
		document.form1.method="post";	
		document.form1.action = "cheque_detail.php?pay_id=" + pay_id + "&url=cheque_paid.php&urlPage=<?=$cPage?>";
		document.form1.submit();
	}
	...
	function paging(pageno)
	 {
		 document.form1.method = "post";
		 document.form1.action = "cheque_paid.php?cPage=" + pageno;
		 document.form1.submit();
	 }
						...
						<td width="700px" height="400" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                          ...
                          <tr>
                            <td width="772" valign="top"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
                              <tr>
                                <td width="73%" height="30" class="headingRegister" >&nbsp;<span class="heading_black">  Paid Cheque  List</span></td>
                          ...
                          <tr>
							...
							?>
							  ...
							  ?>
                                  <tr align="left">
                                    <td width="13%" class="<?=$td_class?>"><a href="#" onClick="chequeDetails(<?=$rsPaid->pay_id?>);"  class="blue_title_small" title="Click to view cheque details."><?=$rsPaid->cheque_number?></a></td>
                                    <td width="13%" class="<?=$td_class?>"><?=getDateValue($rsPaid->pay_date);?></td>
                                    <td width="14%" class="<?=$td_class?>"><?=sprintf("%05d",$rsPaid->pay_id) ?></td>
                                    <td width="12%" class="<?=$td_class?>"><a href="#" onClick="viewDetails('invoice_details.php?invoice_id=<?=$rsPaid->invoice_id?>');" class="paging_text" title="Click to view invoice details.">
                                    ...
                                    <td width="14%" class="<?=$td_class?>_end" ><span class="text_gray_bold">&nbsp;&nbsp;Paid 
                                   </span>
                            ...
                            <td >
								<table width="100%" cellpadding="2" cellspacing="0">
									  <tr>
										...
										<td width="95%" class="star">No Paid Cheques Found.</td>
									  </tr>
									  <tr>
										<td>&nbsp;</td>
									  </tr>
