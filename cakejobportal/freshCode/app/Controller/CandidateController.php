...
////////////////////////////////////////////////////////////////////////////////     
    ...
    {
        if(isset($_SESSION['valpopup'])){
           unset($_SESSION['valpopup']);
        }
    ...
    $auth_data = $this->Auth->user();
        ...
        $seeker_category_drop =  $this->JobOptions->fill_dropdown("seeker_category",'job_options','option_name', "option_name",$seeker_category,"Select","where category_id=14",'','','seeker_category');
        ...
        $seeker_language_home_drop =  $this->JobOptions->fill_dropdown("seeker_language_home",'job_options','option_name', "option_name",$seeker_language_home,"Language","where category_id=15",'','','seeker_language_home');
        ...
        $seeker_language_second_drop =  $this->JobOptions->fill_dropdown("seeker_language_second",'job_options','option_name', "option_name",$seeker_language_second,"Language","where category_id=15",'','','seeker_language_second');
        ...
        $seeker_language_third_drop =  $this->JobOptions->fill_dropdown("seeker_language_third",'job_options','option_name', "option_name",$seeker_language_third,"Language","where category_id=15",'','','seeker_language_third');
        ...
        $seeker_highestdegree_drop =  $this->JobOptions->fill_dropdown('seeker_highestdegree','job_options', 'option_name',"option_name",$seeker_highestdegree,"Select","where category_id=2",'','','seeker_highestdegree');
        ...
        $seeker_seconddegree_drop =  $this->JobOptions->fill_dropdown('seeker_seconddegree','job_options', 'option_name',"option_name",$seeker_seconddegree,"Select","where category_id=2",'','','seeker_seconddegree');
        ...
        $seeker_thirddegree_drop =  $this->JobOptions->fill_dropdown('seeker_thirddegree','job_options', 'option_name',"option_name",$seeker_thirddegree,"Select","where category_id=2",'','','seeker_thirddegree');
	...
	else
	{
        ...
        $seeker_secondarydegree_drop =  $this->JobOptions->fill_dropdown('seeker_secondarydegree','job_options', 'option_name',"option_name",$seeker_secondarydegree,"Select","where category_id=3",'','','seeker_secondarydegree');
	...
	else
	{
        ...
        $seeker_secondaryleadership_drop =  $this->JobOptions->fill_dropdown('seeker_secondaryleadership','job_options', 'option_name',"option_name",$seeker_leadership,"Select","where category_id=10","  onChange='leadershipOther()'",'','seeker_secondaryleadership');
        $this->set('seeker_secondaryleadership_drop',$seeker_secondaryleadership_drop);
        $seeker_employer_type[1] = '';
        $seeker_employer_type_drop =  $this->JobOptions->fill_dropdown('seeker_employer_type[]','job_options', 'option_name',"option_name",$seeker_employer_type[1],"Select","where category_id=8",'','','seeker_employer_type');
        $this->set('seeker_employer_type_drop',$seeker_employer_type_drop);
        $seeker_employer_industry[1] = '';
        $seeker_employer_industry_type_drop =  $this->JobOptions->fill_dropdown("seeker_employer_industry[]",'job_options', 'option_name', "option_name",$seeker_employer_industry[1],"Select","where category_id=6",'','','seeker_employer_industry');
        $this->set('seeker_employer_industry_type_drop',$seeker_employer_industry_type_drop);
        $seeker_employer_position[1] ='';
        $seeker_employer_position_drop =  $this->JobOptions->fill_dropdown("seeker_employer_position[]",'job_options', 'option_name', "option_name",$seeker_employer_position[1],"Select","where category_id=7",'','','seeker_employer_position');
    ...
    function photo_gallery()
    {
        ...
        function quick_edit()
        {
			...
			if($getdata){
				...
				$data['JobJobseeker']['seeker_mobile'] = $_REQUEST['pval'];
			}else{
				$data['JobJobseeker']['seeker_id'] = $_REQUEST['id'];
				$data['JobJobseeker']['seeker_mobile'] = $_REQUEST['pval'];
				$this->JobJobseeker->create();
			}    
			$query = $this->JobJobseeker->save($data['JobJobseeker']);
		...
		if(isset($_REQUEST['type']) AND $_REQUEST['type'] == 'name')
                {
			...
			if($getdata){
				...
				$data['CandidateProfile']['seeker_work_history_title'] = $_REQUEST['pval'];
			}else{
				$data['CandidateProfile']['can_id'] = $_REQUEST['id'];
				$data['CandidateProfile']['seeker_work_history_title'] = $_REQUEST['pval'];
				$this->CandidateProfile->create();
			}                        
			...
			if($getdata){
				$data['JobJobseeker']['id'] = $getdata['JobJobseeker']['id'];
				$data['JobJobseeker']['career_summary'] = $_REQUEST['sval'];
			}else{
				$data['JobJobseeker']['seeker_id'] = $_REQUEST['id'];
				$data['JobJobseeker']['career_summary'] = $_REQUEST['sval'];
				$this->JobJobseeker->create();
