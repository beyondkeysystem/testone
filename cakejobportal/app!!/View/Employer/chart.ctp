...
<div style="align:top">
    ...
    <table style="font-size:18px"class="gridtable">
    <tr>
    ...
    <tr>
    <?php foreach ($chart_data as $report_datas) { ?>
    <td><?php if(!empty($report_datas['Report']['icode'])) { echo $report_datas['Report']['icode']; } else { echo "00" ;} ?></td>
    <td><?php if(!empty($report_datas['Report']['serial_no'])){ echo $report_datas['Report']['serial_no']; } else { echo "00"; } ?></td>
    <td><?php if(!empty($report_datas['Report']['icode_period'])) { echo $report_datas['Report']['icode_period']; } else { echo "00";} ?></td>
    <td><?php if(!empty($report_datas['Report']['days'])) { echo $report_datas['Report']['days'];} else { echo "0" ;} ?></td>
    <td><?php if(!empty($report_datas['Report']['minutes'])) { echo $report_datas['Report']['minutes'];} else { echo "00" ;} ?></td>
    <td><?php if(!empty($report_datas['Report']['minutes'])) { echo $report_datas['Report']['avg_pressure'];} else { echo "00" ;} ?></td>
    <td><?php if(!empty($report_datas['Report']['p95'])) { echo $report_datas['Report']['p95']; } else { echo "00";}?></td>
    <td><?php if(!empty($report_datas['Report']['best30'])) { echo $report_datas['Report']['best30']; } else { echo "00"; }  ?></td>
    <td><?php if(!empty($report_datas['Report']['ahi'])) { echo $report_datas['Report']['ahi'] ; } else { "00" ;}?></td>
    <td><?php if(!empty($report_datas['Report']['sni'])) { echo $report_datas['Report']['sni'];} else { echo "00";} ?></td>
     <td><?php if(!empty($report_datas['Report']['percentage'])) { echo $report_datas['Report']['percentage']."%";} else { echo "00%";} ?></td>
    <td><?php if(!empty($report_datas['Report']['created_date'])) { echo $report_datas['Report']['created_date']; } else { echo "00"; }  ?></td>
    <?php } ?>
    </tr>
    </table><br /> <br />
</div>
