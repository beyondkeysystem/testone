...
<div class="Sidebar-Left">
    ...
    <div class="sb_box">
		...
		<div id="popup">
		    ...
		    <span>Contact No: <i  id="prephone" onclick="opentextbox()"><?php echo $pro_data['seeker_mobile']; ?></i>
		    <i id="phone" style="display: none;" >
		    <input type="text" onkeyup="changePhone(this.value)" name="phone" value="<?php echo $pro_data['seeker_mobile']; ?>">
		    </i>
		    </span>
                </div>
            </div>
