...
<section class="profile_main">
        	<div class="profile_name">
            	<h1><?php echo $user_data['first_name']." ".$user_data['last_name']; ?><span><?php if(isset($pro_data['seeker_work_history_title'])) { echo $pro_data['seeker_work_history_title']; } ?></span></h1>
            </div>
...
<?php	if(isset($pro_data['can_video_thumb']))	{ ?>
            ...
            <div class="content_tab" id="horizontalTab">
                <ul>
                    <li><a href="javascript:void(0);"  onclick="javascript:window.location.href='<?=$this->webroot?>candidate/video_gallery/<?=$user_data["name"]?>'"    ><i class="fa fa-film"></i>Videos Gallery</a></li>
