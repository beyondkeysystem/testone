...
?>
    ...
    <?php
        ...
        echo $this->Html->script('/js/design/respond.src.js');
           echo $this->Html->script('/js/design/jquery.accordion.source.js');
            echo $this->Html->script('/js/design/jquery.screwdefaultbuttonsV2.js');
...
<script type="text/javascript">
 $(document).ready(function($){
	 $("body").click(function () {selectbox("close");});
 });
     $(document).ready(function(){
 ...
 $(".select").selectbox();
            ...
            $(function() {
                    $('body').click(function(e) {
                                if ($(e.target).hasClass('sbSelector')) {
                                   // alert("test");
        return false;
    }else{
