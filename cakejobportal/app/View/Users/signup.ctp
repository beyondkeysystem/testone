...
<section class="profile_main">
          <div class="profile_content">
            ...
            <div class="signup_sec login-box">
              ...
              <div class="already_member form-group">Already a member?
              <?php echo $this->Html->link(__('Login Here'), array('controller' => 'users', 'action' => 'login'),
                                           array('class' => 'btn btn-primary','style'=>'padding-left:10px; padding-right:10px;')); ?>
              <!--<a class="blue_btn loginin" href="">Login in here</a>-->
              <?php echo $this->Session->Flash();?>
              </div>
              <div id="pageWrap" class="pageWrap">
                <div class="pageContent login-box">
                  <?php /*echo $this->Form->create('User');*/ ?>
                  
                  <?php echo $this->Form->create('User', array('inputDefaults' => array('label' => false), 'class' => 'form form-horizontal form-group','enctype' => 'multipart/form-data')); ?>
...
<span style="text-decoration: underline;" onclick="javascript:alert('Answer');" class="block_note">Why do I need to provide my date of birth</span>
                      ...
                      <option value="">Please select city</option>
                        ...
                        <div class="inpt_area">
                         ...
                         <input type="text" name="can_state" >
    ...
    <img src="<?php echo $this->webroot; ?>css/images/loading.gif">
                        ...
                        <div class="inpt_area">
                         ...
                         <?php   /*echo $this->Form->input( 'name', array('label' => 'User Name' , 'id' => 'u_name', 'name' => 'can_uname') );*/ ?>
                          <input id="u_name" type="text" onkeyup="javascript:getusername_can(this.value)" name="can_uname" />
                        ...
                        <div class="block_note">
                            ...
                            <label for="ex2_a">I accept the <a href="/users/comingsoon">Terms &amp; Conditions</a> and <a href="/users/comingsoon">Privacy Policies</a> </label>
                      ...
                      <div class="acc_content">
                        ...
                        <div class="inpt_area">
                          ...
                          <?php /*echo $this->Form->textarea('address', array('label' => 'Office Address', 'id' => 'e_add' ,'rows' => '5', 'cols' => '5') );*/ ?>
                            <input type="text" id="e_add" name="emp_address" >
                        </div>
                        <div class="inpt_area">
                            <label for="c_address">ZipCode</label>
                            
                          <?php /*echo $this->Form->textarea('address', array('label' => 'Office Address', 'id' => 'e_add' ,'rows' => '5', 'cols' => '5') );*/ ?>
                            <input type="text" id="e_zipcode" name="emp_zip_code" >
                        </div>
                                                <div class="inpt_area">
                          <label for="slct_c">Select Country</label>
...
<img src="<?php echo $this->webroot; ?>css/images/loading.gif">
                        ...
                        <div class="inpt_area">
                         ...
                         <input id="choose_pass" type="password" name="emp_password" />
                        </div>
                        <div class="inpt_area">
                          <label for="confirn_pass">Confirm Password</label>
                          <input id="confirn_pass" type="password" name="emp_confirm" />
                        </div>
                        <div class="block_note">
                            <input type="checkbox"  name="ex2_a" id="ex2_a">
                            <label for="ex2_a">I accept the <a href="/users/comingsoon">Terms &amp; Conditions</a> and <a href="/users/comingsoon">Privacy Policies</a> </label>
