...
<div class="inpt_area">
    ...
    <input type="text" name="parent_title" value="<?php if(isset($gallery_val['photo_gallery']['parent_title'])) { echo $gallery_val['photo_gallery']['parent_title']; }?>" >
...
<div class="inpt_area">
    ...
    <input type="text" name="child_title_one" value="<?php if(isset($gallery_val['photo_gallery']['child_title_one'])) { echo $gallery_val['photo_gallery']['child_title_one']; }?>" >     
</div>
<div class="inpt_area">
...
<div class="inpt_area">
    ...
    <input type="text" name="child_title_two" value="<?php if(isset($gallery_val['photo_gallery']['child_title_two'])) { echo $gallery_val['photo_gallery']['child_title_two']; }?>" >     
</div>
<div class="inpt_area">
...
<div class="inpt_area">
    ...
    <input type="text" name="child_title_three" value="<?php if(isset($gallery_val['photo_gallery']['child_title_three'])) { echo $gallery_val['photo_gallery']['child_title_three']; }?>" >     
</div>
<div class="inpt_area">
...
<div class="inpt_area">
    ...
    <input type="text" name="child_title_four" value="<?php if(isset($gallery_val['photo_gallery']['child_title_four'])) { echo $gallery_val['photo_gallery']['child_title_four']; }?>" >     
</div>
<div class="inpt_area">
