...
<div class="Sidebar-Right">
    ...
    <div class="box right-box search">
	    ...
	    <a href="<?=$this->webroot?>candidatesearch">Candidate Search</a>        	
        </div>
    ...
    <a href="<?php echo $this->webroot; ?>chat/room/"><p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.  </p></a>
