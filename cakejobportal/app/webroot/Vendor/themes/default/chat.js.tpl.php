...
<?php //echo $c->data_public_url."<br>".dirname(__FILE__).'/../../src/pfcjson.class.php'; exit;?>
<script type="text/javascript" src="/opt/lampp/htdocs/cakejobportal/app/Vendor/data/public/js/compat.js"></script>
