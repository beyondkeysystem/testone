...
{
	$links[] = '<li id="navregister"'.((PUN_ACTIVE_PAGE == 'register') ? ' class="isactive"' : '').'><a href="/cakejobportal/users/signup/">'.$lang_common['Register'].'</a></li>';
...
else
{
	...
	$links[] = '<li id="navlogout"><a href="/cakejobportal/users/logout">'.$lang_common['Logout'].'</a></li>';
}
