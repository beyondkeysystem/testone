...
<script language="javascript">
 ...
 function editPlan(pid)
 {
	...
	if(validatePlanRec())
	{
		...
		document.form1.action="plan_edit_action.php?pid="+pid+"&type=rec";
                          ...
                          <tr>
                            <td align="left" valign="top"><table width="700" border="0" align="center" cellpadding="8" cellspacing="0" class="table_black_border">
									  ...
									  <tr>
                                        ...
                                        <td class="td_border_right"><input type="checkbox" name="unlimited_job_ads" value="1" <? if($rsplan->unlimited_job_ads==1){ echo("checked"); }?> > </td>
                                      </tr>
									  <tr>
									  ...
									  <tr id="rate_row" >
                                        <td class="td_border_right" >Rate (N$)</td>
                                        <td class="td_border_right" ><input type="text" name="rate" value="<?=$rsplan->rate?>">
									  ...
									  <tr id="positions_row" >
										...
										<tr>
											<td width="46%" valign="top" class="td_border_right">Rate of additional position (N$)</td>
											<td width="54%" align="left" valign="top"  class="td_border_right">
											  <input name="rate_per_position" type="text" id="rate_per_position"  value="<?=$rsplan->rate_per_position?>">
