<?  session_start();
	...
	$sqladvert = "select * from  job_banner order by banner_title";
...
<script language="javascript">
 ...
 function deletebanner(aid)
 {
 	if(confirm("Are you sure you want to delete this banner?"))
	{
		...
		document.form1.action="banner_delete.php?aid="+aid;
						...
						<td width="700px" height="400" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                          ...
                          <tr>
                            <td width="772" valign="top"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
                              <tr>
                                <td width="73%" height="30" class="headingRegister" >&nbsp;<span class="heading_black"> Banner List</span></td>
                                ...
                                <tr>
                                  <td colspan="2" valign="top"><table width="100%" cellpadding="5" cellspacing="0">
                                      <tr>
                                        <td width="5"></td>
                                        <td width="98%">A list of the namrecruit banners. </td>
                                      </tr>
                                  </table></td>
                                </tr>
                            </table></td>
							 ...
							 ?>
							  ...
							  <tr>
                                <td align="center"><table width="95%" cellpadding="6" cellspacing="0" class="table_black_border">
                                    <tr align="left">
                                      <td class="table_head">Banner Title </td>
							  ...
							  ?>
                                    <tr align="left">
                                      <td width="25%" class="<?=$td_class?>"><?=$rsadvert->banner_title ?></td>
                                      <td width="33%" class="<?=$td_class?>"><?=$rsadvert->banner_url?></td>
                                      <td width="17%" class="<?=$td_class?>"><?=showStatus('banner','banner_id',$rsadvert->banner_id,'banner_status',$rsadvert->banner_status,'job_banner'); ?></td>
                                      <td width="25%" class="<?=$td_class?>_end"><a href="banner_edit.php?aid=<?=$rsadvert->banner_id?>" class="paging_text">Edit</a> &nbsp;&nbsp;&nbsp;<a href="#" class="paging_text" onClick="return deletebanner(<?=$rsadvert->banner_id?>)">Delete </a></td>
                                    </tr>
                                    <?
									$i++;
								}
