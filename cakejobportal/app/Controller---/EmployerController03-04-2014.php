...
class EmployerController extends AppController {
	...
	var $uses = array('User','TransMember','FavoriteCandidate','Follow','UpgradeCategory','TrackJobAdvert', 'JobAd','JobOptions','EmployerProfile', 'JobCountry', 'JobCity', 'JobRecInvoices', 'JobRecPaymentPlans','Notification' , 'JobAdTemp', 'PaymentsTable' , 'Plantable');
		...
		function postAddAction()
	{
		...
		if(isset($_POST["department"]))
			$array2["department"] = $_POST["department"];
		else
