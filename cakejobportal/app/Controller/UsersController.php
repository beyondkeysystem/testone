...
////////////////////////////////////////////////////////////////////////////////
    ...
    public function login() {
        ...
        if ($this->request->is('post')) {
		    ...
		    /*$flux_All= $this->User->find('all', array('fields' => 'FluxUser.name',
			'joins' => array(
			    array(
				'type' => 'INNER',
				'table' => 'fluxbb2_users',
		    ...
		    $this->Cookie->write("allUsers",$flux_All);*/
...
////////////////////////////////////////////////////////////////////////////////
    ...
    public function signup() {
        ...
        if ($this->request->is('post')) {
	     ...
	     $can_state =   $_POST['can_state'];
             ...
             $emp_address =   $_POST['emp_address'].", ".$_POST['emp_zip_code']; 
	...
	$query = $this->TransMemberMembershipScheme->save($arr_job['TransMemberMembershipScheme']);
		...
		if($cakeEmail->send()) {
			$this->Session->setFlash(__('Congratulations you have successfully registered.'), 'flash/success');
        ...
        if (!empty($this->data)) {
            ...
            if (!empty($user_data)) {
                ...
                if (!empty($save_result)) {
                    ...
                    $ResetEmail->from(array('info@recruityoung.com'));
					...
					$this->Session->setFlash(__("Email sent for reset password"));
