...
<link type="text/css" media="screen" rel="stylesheet" href="thickbox.css" />
                  ...
                  <td valign="top"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="100%" >
                      ...
                      <tr>
                        ...
                        <td width="40%" align="left" class="heading_black" ><? if($rstemp->seeker_cv !="") {?>
                                    <a href="../../resumedocs/<?=stripslashes($rstemp->seeker_cv)?>" target="_blank" class="comment"><u>download this jobseeker's CV</u></a>
                                    <? } ?>
&nbsp;&nbsp;&nbsp;&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="60%" height="30" class="heading_black" >&nbsp;</td>
                        <td width="40%" align="left" class="heading_black" ><? if($rstemp->seeker_qualification_doc !="") {?>
                                    <a href="../../resumedocs/<?=stripslashes($rstemp->seeker_qualification_doc)?>" target="_blank" class="comment"><u>download this jobseeker's Qualification document</u></a>
                                    <? } ?>
&nbsp;&nbsp;&nbsp;&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="60%" height="30" class="heading_black" >&nbsp;</td>
                        <td width="40%" align="left" class="heading_black" ><? if($rstemp->seeker_driv_licence_doc !="") {?>
                                    <a href="../../resumedocs/<?=stripslashes($rstemp->seeker_driv_licence_doc)?>" target="_blank" class="comment"><u>download this jobseeker's Driving Licence</u></a>
                                    <? } ?>
&nbsp;&nbsp;&nbsp;&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="60%" height="30" class="heading_black" >&nbsp;</td>
                        <td width="40%" align="left" class="heading_black" ><? if($rstemp->seeker_service_doc !="") {?>
                                    <a href="../../resumedocs/<?=stripslashes($rstemp->seeker_service_doc)?>" target="_blank" class="comment"><u>download this jobseeker's Certificate of Service</u></a>
                                    <? } ?>
&nbsp;&nbsp;&nbsp;&nbsp;</td>
                      </tr>
					  <!--this is new link-->
					   <tr>
                        <td width="60%" height="30" class="heading_black" >&nbsp;</td>
                        <td width="40%" align="left" class="heading_black" > <? if( $rstemp->seeker_family_video != "" ) { ?><a href="showvideo.php?height=385&width=650&vid=<?=$rstemp->seeker_family_video?>" class="thickbox"><strong>view uploaded video</strong></a><? } ?>
&nbsp;&nbsp;&nbsp;&nbsp;</td>
                      </tr>
					  <!-- till here-->
                      <tr>
                  ...
                  <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                      <tr>
                        <td width="782"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" ><tr><td width="779" height="30" class="subhead_gray_small" ><table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
                          ...
                          <? if ( ( $rsSeeker->seeker_tertiary_higherdegree !="" && $rsSeeker->seeker_tertiary_higherfield !="" && $rsSeeker->seeker_tertiary_higherinstitution !="" && $rsSeeker->seeker_tertiary_highertodate !="" && $rsSeeker->seeker_tertiary_secounddegree !="" && $rsSeeker->seeker_tertiary_secoundfield != "" && $rsSeeker->seeker_tertiary_secoundinstitution != "" && $rsSeeker->seeker_tertiary_secoundfromdate != "" && $rsSeeker->seeker_tertiary_secoundtodate && $rsSeeker->seeker_tertiary_thirddegree != "" && $rsSeeker->seeker_tertiary_thirdfield != "" && $rsSeeker->seeker_tertiary_thirdinstitution != "" && $rsSeeker->seeker_tertiary_thirdfromdate !="" && $rsSeeker->seeker_tertiary_thirdtodate != "" ) or ($rsSeeker->seeker_secoundary_degree !="" && $rsSeeker->seeker_secoundary_institution !="" && $rsSeeker->seeker_secoundary_fromdate !="" && $rsSeeker->seeker_secoundary_todate !="" ) or ( $rsSeeker->seeker_secoundary_leadership != "" ) or ( $rsSeeker->seeker_computer != "" ) ) { ?>
                          <tr>
                                  ...
                                  <? if( $rstemp->seeker_summary !="") { ?>
                                      ...
                                      <? if ($rstemp->seeker_register_type != 2) {?>
                                       <? 
										...
										$posCatt4 	= 	"";
										$posCatt5 	= 	"";
										$posCat 	= 	( isset($_POST['seeker_work_cat']) ) ? stripslashes( $_POST['seeker_work_cat'] ) :	$rstemp->seeker_work_cat ;
										$posCatt2 	= 	( isset($_POST['seeker_work_cat2'])) ? stripslashes( $_POST['seeker_work_cat2']) :	$rstemp->seeker_work_cat2 ;
										$posCatt3 	= 	( isset($_POST['seeker_work_cat3'])) ? stripslashes( $_POST['seeker_work_cat3']) :	$rstemp->seeker_work_cat3 ;
										$posCatt4 	= 	( isset($_POST['seeker_work_cat4'])) ? stripslashes( $_POST['seeker_work_cat4']) :	$rstemp->seeker_work_cat4 ;
										$posCatt5 	= 	( isset($_POST['seeker_work_cat5'])) ? stripslashes( $_POST['seeker_work_cat5']) :	$rstemp->seeker_work_cat5 ;
										
										if( $posCat != "" ){
		?>
         <tr >
            <td width="23%" >Position 1</td>
            <td colspan="2" ><?=stripslashes( $posCat )?></td>
          </tr><? } ?>
          <? if( $posCatt2 !="" ) { ?>
          <tr >
            <td width="23%" >Position 2</td>
            <td colspan="2" ><?=stripslashes( $posCatt2 ) ?></td>
          </tr>
          <? } ?>
           <? if( $posCatt3 !="" ) { ?>
          <tr >
            <td width="23%" >Position 3</td>
            <td colspan="2" ><?=stripslashes( $posCatt3 )?></td>
          </tr>
          <? } ?>
           <? if( $posCatt4 !="" ) { ?>
          <tr >
            <td width="23%" >Position 4</td>
            <td colspan="2" ><?=$posCatt4?></td>
          </tr>
          <? } ?>
           <? if( $posCatt5 !="" ) { ?>
          <tr >
            <td width="23%" >Position 5</td>
            <td colspan="2" ><?=stripslashes( $posCatt5 )?></td>
          </tr>
       <? } } ?>
      ...
      After hrs employment </td>
									...
									?> 
                                    <? # newly added code for position 
									$posCat 	= 	"";
									$posCatt2 	= 	"";
									$posCatt3 	= 	"";
									$posCatt4 	= 	"";
									$posCatt5 	= 	"";
									$posCat 	= 	( $rstemp->seeker_work_cat != "" ) ?  $rstemp->seeker_work_cat	 : "" ;
									$posCatt2 	= 	( $rstemp->seeker_work_cat2 != "" ) ? $rstemp->seeker_work_cat2  : "" ;
									$posCatt3 	= 	( $rstemp->seeker_work_cat3 != "" ) ? $rstemp->seeker_work_cat3  : "" ;
									$posCatt4 	= 	( $rstemp->seeker_work_cat4 != "" ) ? $rstemp->seeker_work_cat4  : "" ;
									$posCatt5 	= 	( $rstemp->seeker_work_cat5 != "" ) ? $rstemp->seeker_work_cat5  : "" ;
									
									if( $posCat != "" ){
									?>
									 <tr >
                                    <td width="37%" align="left" height="20" >Position 1</td>
                                    <td width="63%" align="left" height="20"><?=stripslashes( $posCat )?></td>
                                  </tr><? } ?>
                                  <? if( $posCatt2 !="" ) { ?>
                                  <tr >
                                    <td width="37%" align="left" height="20">Position 2</td>
                                    <td width="63%" align="left" height="20"><?=stripslashes( $posCatt2 ) ?></td>
                                  </tr>
                                  <? } ?>
                                   <? if( $posCatt3 !="" ) { ?>
                                  <tr >
                                    <td width="37%" align="left" height="20">Position 3</td>
                                    <td width="63%" align="left" height="20"><?=stripslashes( $posCatt3 )?></td>
                                  </tr>
                                  <? } ?>
                                   <? if( $posCatt4 !="" ) { ?>
                                  <tr >
                                    <td width="37%" align="left" height="20">Position 4</td>
                                     <td width="63%" align="left" height="20"><?=$posCatt4?></td>
                                  </tr>
                                  <? } ?>
                                   <? if( $posCatt5 !="" ) { ?>
                                  <tr >
                                    <td width="37%" align="left" height="20">Position 5</td>
                                     <td width="63%" align="left" height="20"><?=stripslashes( $posCatt5 )?></td>
                                  </tr>
                               <? } ?>
                                  <? if($rstemp->seeker_work_subcat != "" )  {?>
                                    <tr>
