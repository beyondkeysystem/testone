...
<table width="990" border="0" align="center" cellpadding="0" cellspacing="0">
     ...
     <tr>
         <td class="whitebgcolor"><form name="form1" action="job_edit_1.php?ad_id=<?=$_GET['ad_id']?>" method="post" enctype="multipart/form-data" target="postProcess"  >
		   ...
		   <input type="hidden" name="hurl" value="job_edit_3.php">
               ...
               <td width="772"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
                   ...
                   <tr>
                     <td valign="top"><table width="100%" cellpadding="5" cellspacing="0">
                         <tr>
                           <td width="7">&nbsp;</td>
                           <td colspan="2"> You can update   job advert for  vacation work or a job attachment position here.</td>
                         </tr>
                         <tr>
                         ...
                         <tr>
                           <td>&nbsp;</td>
                           <td valign="top">Holiday work / job attachment employment availability</td>
                           <td colspan="2" valign="top" class="normal_black"><table width="100%" cellpadding="2" cellspacing="0">
                               <tr>
                                 <td width="43%" class="normal_black">From</td>
                                 <td width="57%" class="normal_black">To</td>
                               </tr>
                               <tr>
                                 <td><? if ($date_of_taking == "" ) echo createDateAdd("date_of_taking"); else echo createDateAdd("date_of_taking",$date_of_taking);  ?></td>
                                 <td><? if ($date_of_takingTo == "" ) echo createDateAdd("date_of_takingTo"); else echo createDateAdd("date_of_takingTo",$date_of_takingTo);  ?>
               ...
               <td colspan="2"><table width="100%" cellpadding="5" cellspacing="0">
                   ...
                   <tr>
					 ...
					 <img src="../images/back.gif" width="53" height="20" border="0" onClick="goBack('<?=$redirectUrl?>');" style="cursor:pointer">
                       &nbsp;&nbsp;&nbsp; <img src="../../images/update.gif" width="60" height="22" border="0" onClick="edit_job_ad_3(document.form1);" style="cursor:pointer"> </td>
                   </tr>
               </table></td>
             </tr>
           </table>
