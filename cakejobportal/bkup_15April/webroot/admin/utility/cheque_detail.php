<?  session_start();
	...
	{
		$chkstatus="New Cheque";
	}
	else if($rsPay->pay_status==1)
	{
		$chkstatus="Paid Cheque";
	}
	else if($rsPay->pay_status==2)
	{
		$chkstatus="Received Cheque";
	}
	else if($rsPay->pay_status==4)
	{
		$chkstatus="Not Received Cheque";
	}
	else if($rsPay->pay_status==3)
	{
		$chkstatus="Bounce Cheque";
	}
					...
					<tr>
						<td width="772" valign="top">
							<table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
								...
								<tr>
									<td height="30" class="heading_black" >&nbsp;Cheque Details </td>
								</tr>	
								<tr>
									<td valign="top">
										<table width="100%" cellpadding="5" cellspacing="0">
										  ...
										  <tr>
											...
											Cheque No :<? echo($rsPay->cheque_number);?></td>
									      </tr>
										  <tr>
						...
						<td align="center">
							<table width="90%" cellpadding="6" cellspacing="0" class="table_black_border">
							  <tr>
								...
								<td align="left" class="table_head">Cheque Date</td>
							  ...
							  ?>
								<tr>
								  <td width="4%" class="<?=$td_class?>"><?=$i?>)</td>
									<td width="16%" align="left" class="<?=$td_class?>"><?=getDateValue($rsPay->cheque_date); ?></td>
