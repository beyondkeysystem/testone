<?  session_start();
	...
	$objDb = new db();
	$rowCount=0;
	$sqlPaid = "select * from  job_rec_payments where paid_by='Cheque'  order by pay_id desc";
...
<script language="javascript" type="text/javascript">
	function viewDetails(location)
	{
		...
		document.form1.action = location + "&url=cheque_list.php&urlPage=<?=$cPage?>";
	...
	{
		document.form1.method="post";	
		document.form1.action = "cheque_detail.php?pay_id=" + pay_id + "&url=cheque_list.php&urlPage=<?=$cPage?>";
		document.form1.submit();
	}
	...
	function paging(pageno)
	 {
		 document.form1.method = "post";
		 document.form1.action = "cheque_list.php?cPage=" + pageno;
		 document.form1.submit();
	 }
	...
	function submitform()
	{
		...
		else
		{
			...
			{
				document.form1.action="cheque_action.php?link=new";
				document.form1.method="post";
				document.form1.submit();
			}
		}
	...
	function confirmActive(id,Iid)
	{
		...
		{
			location.href="payment_status.php?type=2&pid="+id+"&Iid="+Iid;
		}	
	}
						...
						<td width="700px" height="400" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                          ...
                          <tr>
                            <td width="772" valign="top"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
                              <tr>
                                <td width="73%" height="30" class="headingRegister" >&nbsp;<span class="heading_black"> New Cheque List</span></td>
                            ...
                            <td><table  align="left" cellpadding="6" cellspacing="0" border="0" >
							  ...
							  <tr>
                                <td align="center"><table width="95%" cellpadding="6" cellspacing="0" class="table_black_border">
                                  ...
                                  <tr>
                                    ...
                                    <td width="19%" align="left" class="table_head">Recruiter Name </td>
                                    <td align="left" class="table_head">Amount</td>
                                    <td align="center" class="table_head_end">Cheque Status </td>
                                  </tr>
                                  <?
								$i = 1;
							  ...
							  ?>
                                  <tr>
                                    ...
                                    <td width="13%" align="left" class="<?=$td_class?>"><a href="#" onClick="viewDetails('invoice_details.php?invoice_id=<?=$rsPaid->invoice_id?>');" class="paging_text" title="Click to view invoice details.">
                                    ...
                                    <td width="14%" align="left" class="<?=$td_class?>">N$
                                        <?=number_format($rsPaid->pay_amount,2,'.','')?></td>
                                    <td width="19%" align="center" class="<?=$td_class?>_end"><span class="text_gray_bold">
                                     	<span class="<?=$td_class?>_end"><span class="text_gray_bold"><? if($rsPaid->pay_status==0) {?> <a href="#" onClick="confirmActive(<?=$rsPaid->pay_id?>,<?=$rsPaid->invoice_id?>)" class="<?=$td_class?>_end">Inactive</a> <? } else if($rsPaid->pay_status==1) echo("Active");?>
											</span></span>
                                    </span>
                            ...
                            <td >
								<table width="100%" cellpadding="2" cellspacing="0">
									  <tr>
										...
										<td width="95%" class="star">No New Cheques Found.</td>
									  </tr>
									  <tr>
										<td>&nbsp;</td>
									  </tr>
