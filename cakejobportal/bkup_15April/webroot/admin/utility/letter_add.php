...
<script language="javascript">
 ...
 function addLetter()
 {
	...
	{		
		...
		document.form1.action="letter_add_action.php";
						...
						<td width="700px" height="400" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                          <tr>
                            <td width="772" valign="top"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
                                <tr>
                                  <td height="30" class="heading_black" >&nbsp;Add New Cover Letter </td>
                                </tr>
								<tr>
                                  <td valign="top"><table width="100%" cellpadding="5" cellspacing="0">
                                      <tr>
                                        <td width="5"></td>
                                        <td width="98%">You can add a new cover letter here. </td>
                                      </tr>
                                  </table></td>
                                </tr>
                                <tr>
                          ...
                          <tr>
							...
							<table width="800" border="0" align="left" cellpadding="6" cellspacing="0" >
										<tr>
										  <td valign="top"   >&nbsp;</td>
										  <td height="30" align="left" valign="top" class="normal_text"    ><input type="text" name="title" size="70"> 
									      (Letter Title) </td>
							  </tr>
										<tr>
                                          <td >&nbsp;</td>
                                          <td ><textarea name="msg" cols="80" rows="15" id="msg"></textarea>
                                              <img src="../../images/star.gif"> </td>
							  </tr>
										<tr>
                                          <td valign="top"   >&nbsp;</td>
                                          <td height="30" align="left" valign="top"    ><img src="../../images/add.gif" border="0" style="cursor:pointer" onClick="return addLetter();">&nbsp;&nbsp;&nbsp;<a href="home.php"><img src="../../images/cancel.gif" border="0"></a></td>
							  </tr>
										<tr>
