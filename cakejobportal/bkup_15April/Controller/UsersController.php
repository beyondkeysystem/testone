...
class UsersController extends AppController {
    ...
    var $uses = array('User', 'ResetPassword','JobComment','JobCv','TransMember', 'EmployerDetail', 'JobCountry','JobJobseeker', 'JobCity','JobState','TransMemberMembershipScheme', 'TransMemberVideo');
