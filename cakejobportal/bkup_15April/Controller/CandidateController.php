...
class CandidateController extends AppController {
    ...
    var $uses = array('TransFilmmakersChat', 'JobComment','VideoGallery','TransMemberMembershipScheme', 'TransMemberVideo', 'TransVideoCc', 'User','TransMember','Follow','FavoriteCandidate','JobRecruiterfollowcv','JobJobseeker','JobShortlistedJobseeker','JobAppliedjobs','CandidateProfile','UpgradeCategory','TrackJobAdvert', 'JobAd','JobOptions','EmployerProfile', 'JobCountry', 'JobCity', 'JobRecInvoices', 'JobRecPaymentPlans','Notification' , 'JobAdTemp', 'PaymentsTable' , 'Plantable');
