...
class UsersController extends AppController {
    ...
    var $uses = array('User', 'ResetPassword', 'EmployerDetail');
...
////////////////////////////////////////////////////////////////////////////////
    ...
    public function login() {
        ...
        if ($this->request->is('post')) {
            $this->Auth->authenticate['Form'] = array('fields' => array('username' => 'email','username' => 'name'));
            if ($this->Auth->login()) {
...
////////////////////////////////////////////////////////////////////////////////
    ...
    public function signup() {
        ...
        if(isset($emp_company_name) AND $emp_company_name !='' )
        {
            ...
            'password' => $emp_password,'company_name'=> $emp_company_name,'office_address'=> $emp_address,'city'=> $emp_city,'country' => $emp_country);
            //pr($arr);
            //die;
        $this->User->create();
        ...
        else
        {
            ...
            'password' => $can_password,'city'=> $can_city,'country' => $can_country, 'first_name' => $can_fname , 'last_name'=> $can_lname, 'dob' => $dob);
             $this->User->create();
        ...
        if (!empty($this->data)) {
            ...
            if (!empty($user_data)) {
                ...
                if (!empty($save_result)) {
                    ...
                    $ResetEmail->subject('Reset password link from connect.3bproducts.com');
                    $ResetEmail->emailFormat('html');
                    $body = "Hello ,";
                    $body .=" <br/><br/>Click on below link for reset your password";
                    $body .="<br/><a href='https://connect.3bproducts.com/users/reset/$user_random'>https://connect.3bproducts.com/users/reset/$user_random</a>";
                    $email = $user_Demail;
