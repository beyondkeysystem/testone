...
<?php	if(isset($pro_data['can_video_thumb']))	{ ?>
            ...
            <div class="content_tab" id="horizontalTab">
                ...
                <div id="tab-1">
                    <p><?php if(isset($pro_data['video_summary'])) { echo $pro_data['video_summary']; } else { echo $this->Html->link(__('To add videos gallery summary click here', array('controller' => 'Candidate', 'action' => 'candidate_profile_edit'))); }  ?></p>
                </div>
                <div id="tab-2">
                    <p><?php if(isset($pro_data['photo_summary'])) { echo $pro_data['photo_summary']; } else { echo $this->Html->link(__('To add photos gallery summary click here', array('controller' => 'Candidate', 'action' => 'candidate_profile_edit'))); }  ?></p>
                </div>
                <div id="tab-3">
                    <p><?php if(isset($pro_data['link_summary'])) { echo $pro_data['link_summary']; } else { echo $this->Html->link(__('To add Links / Articles summary click here', array('controller' => 'Candidate', 'action' => 'candidate_profile_edit'))); }  ?></p>
                </div>
                <div id="tab-4">
                    <p><?php if(isset($pro_data['forum_summary'])) { echo $pro_data['forum_summary']; } else { echo $this->Html->link(__('TO add forum summary click here', array('controller' => 'Candidate', 'action' => 'candidate_profile_edit'))); }  ?></p>
                </div>
                <div id="tab-5">
                    <p><?php if(isset($pro_data['message_summary'])) { echo $pro_data['message_summary']; } else { echo $this->Html->link(__('TO add message summary click here', array('controller' => 'Candidate', 'action' => 'candidate_profile_edit'))); }  ?></p>
                </div>
        
            </div>
            <?php foreach($seeker_data_set as $key=>$seeker_data_value) { ?>
