...
<script language="javascript">
 ...
 function addAdvert()
 {
	...
	if(validateAdverts())
	{
		...
		document.form1.action="advert_add_action.php";
						...
						<td width="700px" height="400" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                          <tr>
                            <td width="772" valign="top"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
                                <tr>
                                  <td height="30" class="heading_black" >&nbsp;Add Advert </td>
                                </tr>
								<tr>
                          ...
                          <tr>
                            <td align="left" valign="top"><table width="600" border="0" align="left" cellpadding="6" cellspacing="0" >
									  ...
									  <tr>
                                        ...
                                        <td >
                                          <textarea name="desc1" cols="30"></textarea>
                                          <img src="../../images/star.gif"> </td>
                                      </tr>
										...
										<tr>
										  <td width="2%" valign="top"   >&nbsp;</td>
											...
											<td width="79%" height="30" align="left" valign="top"    >												<img src="../../images/add.gif" border="0" style="cursor:pointer" onClick="return addAdvert()">&nbsp;&nbsp;&nbsp;<a href="home.php"><img src="../../images/cancel.gif" border="0"></a>
										  </td>
										</tr>
									</table></td>
                          </tr>
