<?  session_start();
	...
	$objDb = new db();
	$sqladvert = "select * from  job_banner  where banner_id='".$_GET["aid"]."'";
...
<script language="javascript">
 ...
 function editBanner(aid)
 {
 	
	if(validateBannerEdit())
	{
		document.form1.method="post";
		document.form1.action="banner_edit_action.php?aid="+aid;
						...
						<td width="700px" height="400" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                          <tr>
                            <td width="772" valign="top"><table  align="left" cellpadding="0" cellspacing="0" border="0" width="98%" >
                                <tr>
                                  <td height="30" class="heading_black" >&nbsp;Edit Banner </td>
                                </tr>
								<tr>
                                  <td valign="top"><table width="100%" cellpadding="5" cellspacing="0">
                                      <tr>
                                        <td width="5"></td>
                                        <td width="98%">You can edit the banner here. </td>
                                      </tr>
                                  </table></td>
                                </tr>
                                <tr>
							 ...
							 ?>
                              ...
                              <? }?>
									  ...
									  <tr>
									    <td    >&nbsp;</td>
                                        <td    >Banner Title</td>
                                        <td    ><input type="text" name="title" value="<?if(isset($_POST['banner_title']) && $_POST['banner_title']!="" ) echo $_POST['banner_title']; else  echo $rsadvert->banner_title;?>" >
									  ...
									  <tr>
                                        ...
                                        <td    >Banner URL</td>
                                        <td    >
                                          <input name="url" type="text" value="<?if(isset($_POST['banner_url']) && $_POST['banner_url']!="" ) echo $_POST['banner_url']; else  echo $rsadvert->banner_url;?>" size="40">
                                          <img src="../../images/star.gif"> </td>
                                      </tr>
                                      <tr>
                                        <td >&nbsp;</td>
                                       ...
                                       <tr>
                                        ...
                                        <td >
                                            ...
                                            <img src="../../upload_banner/<?=$rsadvert->banner_image?>"  >
                                         </td>
                                      </tr>
										...
										<tr>
										  <td width="2%" valign="top"    >&nbsp;</td>
											...
											<td width="79%" align="left" valign="top"     >												<img src="../../images/update_admin.gif" border="0" style="cursor:pointer" onClick="return editBanner(<?=$rsadvert->banner_id?>)">&nbsp;&nbsp;&nbsp;<a href="banner_list.php"><img src="../../images/cancel.gif" border="0"></a>
										  </td>
										</tr>
									</table></td>
                          </tr>
