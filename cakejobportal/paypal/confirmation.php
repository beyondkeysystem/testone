	  ...
	  <tr>
	    ...
	    <table border="0" width="100%" cellspacing="0" cellpadding="0">
	      ...
	      <select name="expDateMonth">
				...
				<td width="50%" valign="top">
				<?php if(isset($_GET['flag']) AND $_GET['flag']==2){ ?>
				<div align="right">
					<table border="0" width="98%" cellspacing="0" cellpadding="4" class="content4" style="border:1px solid #333333;">
						...
						if(isset($err[L_LONGMESSAGE0]) AND $err[L_LONGMESSAGE0] != ""){
							print  $err[L_LONGMESSAGE0]."<br><br>";
						}
						if(isset($err[L_LONGMESSAGE1]) AND $err[L_LONGMESSAGE1] != ""){
							print  $err[L_LONGMESSAGE1]."<br><br>";
						}
						if(isset($err[L_LONGMESSAGE2]) AND $err[L_LONGMESSAGE2] != ""){
