...
$google_client_id 		= '483976106714-uugaguemgucuk6i749tvsmplsqh45844.apps.googleusercontent.com';
$google_client_secret 	= 'VmuaFqgJZcQPuQDJlbvfXWTP ';
$google_redirect_url 	= 'http://fss.pd.cisinlive.com/google-login-api/'; //path to your script
$google_developer_key 	= '483976106714-uugaguemgucuk6i749tvsmplsqh45844@developer.gserviceaccount.com';

########## MySql details (Replace with yours) #############
$db_username = "root"; //Database Username
$db_password = ""; //Database Password
$hostname = "localhost"; //Mysql Hostname
$db_name = 'alex'; //Database Name
###################################################################
...
$gClient->setApplicationName('Micro Blog');
