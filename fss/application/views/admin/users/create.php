    ...
    <form accept-charset="utf-8" method="post" id="" class="form-horizontal" action="">
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="password" id="" name="users[password]" value="<?php if (isset($users['password'])) echo $users['password']; ?>">
            ...
            <div class="form-actions">
                ...
                <button class="btn" type="reset" onclick="window.location.href = '/admin/users/manage'">Cancel</button>
            </div>
        </fieldset>
