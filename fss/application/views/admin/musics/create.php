...
<div class="container top">
    ...
    <form accept-charset="utf-8" method="post" id="" class="form-horizontal" action="" enctype="multipart/form-data">
        <fieldset>
            ...
            <div class="control-group">
                <label for="inputError" class="control-label">Music Type</label>
                <div class="controls">
                    <input type="text" id="" name="musics[music_type]" value="<?php if (isset($musics['music_type'])) echo $musics['music_type']; ?>">
                    <?php echo form_error('musics[music_type]', '<div class="form_error">', '</div>'); ?>
                </div>
            </div>
            <div class="control-group">
