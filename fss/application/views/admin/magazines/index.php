      ...
      <table class="table table-striped table-bordered table-condensed">
        <thead>
            <tr>
                ...
                <th class="yellow header headerSortDown">Editor</th>
        ...
        <tbody>
            ...
            <tr class="<?php if($i%2==0) echo 'odd';else echo 'even';?>">
                ...
                <td><?php 
                    if(isset($result->is_published) and $result->is_published =='1'){
                        echo 'Approved';
                    }else if(isset($result->is_published) and $result->is_published =='0'){
                        echo 'Declined';
                    }else{
                ...
                ?></td>
                <td><?php 
                    if(isset($result->is_editor) and $result->is_editor =='1'){
                        echo 'Yes';
                    }else{
                        echo 'No';
                    }
                ...
                <td>
                    ...
                    <a href="/index.php/admin/magazines/is_approve/<?php echo $result->id?>/u" title="Decline"><img src="/assets/img/unapproved.png"></a>
                    ...
                    <?php }?>
                    <a href="/index.php/admin/magazines/is_editor/<?php echo $result->id?>" title="Editor"><img src="/assets/img/editor.png"></a>
                    <a href="/index.php/admin/magazines/is_editor/<?php echo $result->id?>/un" title="Un Editor"><img src="/assets/img/uneditor.png"></a>
                </td>
            </tr>
            <?php $i++; }?>
