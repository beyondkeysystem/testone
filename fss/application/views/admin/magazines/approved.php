        ...
        <tbody>
            ...
            <tr class="<?php if($i%2==0) echo 'odd';else echo 'even';?>">
                ...
                <td>
                    ...
                    <?php if(isset($result->is_active) and $result->is_active == '0'){?>
                    <a href="/index.php/admin/magazines/delete/<?php echo $result->id?>/a" title="Delete"><img src="/assets/img/gr-delete.png"></a>
                    <?php }else{?>
                    <a href="/index.php/admin/magazines/delete/<?php echo $result->id?>/u" title="Delete"><img src="/assets/img/gr-delete.png"></a>
                    <?php }?>
