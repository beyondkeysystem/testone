    ...
    <form accept-charset="utf-8" method="post" id="" class="form-horizontal" action="" enctype="multipart/form-data">
        ...
        <fieldset>
            <div class="control-group">
                <label for="inputError" class="control-label">User</label>
                <div class="controls">
                    <?php //pr($permission_data);?>
                    <select data-placeholder="Your Favorite Types of Bear" name="user_id[]" style="width:350px;" multiple class="chosen-select" tabindex="8">
                    <option value=""></option>
