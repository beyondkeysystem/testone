                        ...
                        <div id="tb-1" class="tab-pane fade active in">
                            ...
                            <div id="soundcategory">
                                <ol class="song_list">
                                    ...
                                    <li class="playing">
                                        <span class="check">
                                            <input type="radio" name="songs" id="song_<?php echo $music['id']?>"  value="<?php echo $music['id']?>">
                            ...
                            <div class="song_btns" id="hidemusic">
                                ...
                                <div id='showmusic' style='display:none'><img src="/assets/front/images/loader.gif" alt="Uploading...."/></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div> Share pictures: <span class="tixing"><span>(Moderator reminder: Please do not use the two-dimensional code, upload beauties can increase the amount of reading)</span></span><br>
                    <form id="shareform" method="post" enctype="multipart/form-data" action='/magazines/uploadshare' style="clear:both">
                        <div class="weixinInfor">
                            ...
                            <div id="preview"><img src="/assets/front/images/water-img1.jpg" width="156" height="168" id="fileshowpic"></div>
                            <div class="clear"></div>
                        </div>
                    </form>
                    <p class="pop-row"><span class="title">Share Title:</span> <span class="inp-popup">
                            <input type="text" name="share_title" id="mainTitle" maxlength="45" class="form-control">
                    ...
                    <p class="pop-row"><span class="title">Share subtitle:</span> <span class="inp-popup">
                            <input name="fenxianginfo"  maxlength="50" id="fenxianginfo" class="form-control" type="text">
                ...
                <div class="create-left-in">
                    <div class="crt-row">
                        ...
                        <div class="input-group">
                            <input type="text" maxlength="20" name="magazinename"  id="magazinename" class="form-control" placeholder="Magazine names" value="">
                    ...
                    <div class="crt-row">
                        <p>Phone</p>
                        <div class="input-group">
                            <input type="text" maxlength="10" class="form-control" id="magazinephone" name="magazinephone" placeholder="Phone" value="">
                    ...
                    <div class="form-group gender-txt crt-row"><span class="gender-1">
                            <input type="checkbox" name="checkboxG4" id="checkboxG6"  name="watermark" class="css-checkbox">
...
<!--                    <li>Physical
            ...
            <ul class="nav nav-tabs tab-n1">
                ...
                <li>
                    <input onclick="apendcategory(this,'<?php echo $category->id?>');" value="<?php echo $category->category_name?>" type="checkbox" class="css-checkbox categoryChkBox" id="checkboxG261<?php echo $category->id?>" name="checkboxG4[]">
        ...
        <div id='imageloadbutton'>
            <div class="btn-row"> 
<!--                <a href="/magazines/create" class="btn-1">delete</a>  -->
                <a href="javascript:;" class="btn-2" onclick="return fnsubmitform(0);">Submit</a> 
        ...
        <div class="create-btm-box">
            ...
            <div class="ct-btm-list reorder-photos-list" id="preview123"> </div>
        </div>
    </div>
</div>
	...
	function fnpaging(obj){
        ...
        function fnsubmitform(is_draft){
            ...
            if(shareimg ==undefined){
                flag = 0;
                $('#error_common').html('Please select share image');
                alert('Please select share image');
                return false;
            }else{
                //flag = 0;
                $('#error_common').html('');
