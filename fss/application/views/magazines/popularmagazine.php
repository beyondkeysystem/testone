      ...
      <div class="tab-bx">
        <div id="horizontalTab">
          ...
          <ul class="resp-tabs-list-new">
            ...
            <li><a class="magazinetabcls active" href="/magazines/popularmagazine" >Popular magazine</a></li>
          </ul>
...
<script>
    ...
    function fncategory_magazines(id){
        //alert(id);
        window.location.href = '/magazines/popularmagazine?name='+id;
        /*$.ajax({
            type: "POST",
    ...
    function fnsubmit(){
        ...
        window.location.href = '/magazines/popularmagazine?search='+searchdata;
        return false;
    }
</script>