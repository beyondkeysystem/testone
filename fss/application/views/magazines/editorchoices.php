      ...
      <div class="tab-bx">
        <div id="horizontalTab">
          ...
          <ul class="resp-tabs-list-new">
            ...
            <li><a class="magazinetabcls active" href="/magazines/editorchoices" >Editor's Choices</a></li>
...
<script>
    ...
    function fncategory_magazines(id){
        //alert(id);
        window.location.href = '/magazines/editorchoices?name='+id;
        /*$.ajax({
            type: "POST",
    ...
    function fnsubmit(){
        ...
        window.location.href = '/magazines/editorchoices?search='+searchdata;
        return false;
    }
</script>